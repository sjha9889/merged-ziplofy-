import { jsx as o, jsxs as m, Fragment as ae } from "react/jsx-runtime";
import { useState as Z, useMemo as F, useEffect as ue, useRef as ot, useCallback as qe } from "react";
import { getThemeConfigValue as V, useThemeConfig as j, useStorefrontAuth as Ze, useStorefrontCart as xt, useStorefront as it, useStorefrontProducts as ht, formatINR as Ye, useThemeEditorPreview as rt, usePreviewHighlightNodeId as gi, layoutBlockIdFromHighlightNodeId as fi, useStorefrontOrder as bi, useStorefrontProductVariants as yi } from "@render-store/sdk";
import { useLocation as xi, Link as I, useNavigate as $t, useParams as $i } from "react-router-dom";
function l(e, t, i = "") {
  const n = V(e, t);
...
function O({ sectionId: e, label: t, style: i, children: n, editorNodeId: s }) {
  const u = s ?? `layout:${e}`;
  return /* @__PURE__ */ o(
    "section",
    {
...
function B() {
  const e = j(), t = String(V(e, "settings.colors.primary") ?? "#111827"), i = String(V(e, "settings.colors.background") ?? "#ffffff"), n = String(V(e, "settings.colors.text") ?? "#111827"), s = String(
    V(e, "settings.typography.fontFamily") ?? "Georgia, serif"
  ), u = String(
    V(e, "settings.typography.fontFamilyBody") ?? "system-ui, sans-serif"
  );
  ...
  return i === "link" ? /* @__PURE__ */ o(
    ...
    "button",
    {
      ...
      style: {
        ...
        fontWeight: 600,
        cursor: "pointer",
        padding: t === "arrow" ? "12px 16px" : "12px 20px",
        lineHeight: 1
      },
      children: u
    }
...
function Do({ sectionId: e = "footer" }) {
  const t = j(), { fontHeading: i, fontBody: n, text: s, background: u, primary: d } = B(), [a, r] = Z(""), p = `sections.${e}.settings`, c = `sections.${e}.blocks.newsletter.settings`, h = F(() => {
    const w = Si(t, p, {
      background: "#f9fafb",
      color: "#111827",
      border: R.line
    }), L = Go(t, p), T = wi(t, p), { paddingTop: W, paddingBottom: P } = _i(t, p), C = l(t, `${p}.customCss`, "");
    return {
      scheme: w,
      widthMode: L,
      gap: T,
  ...
  ), $ = l(t, `${c}.placeholder`), b = l(t, `${c}.buttonLabel`), v = (w) => {
    w.preventDefault(), r("");
  }, x = h.widthMode === "full" ? "100%" : R.maxWidth, z = h.widthMode === "full" ? 0 : R.padX, S = {
    width: "100%",
    maxWidth: g.blockWidth === "custom" ? 520 : void 0,
  ...
  return /* @__PURE__ */ m(
    O,
    {
      ...
      children: [
        h.customCss ? /* @__PURE__ */ o("style", { dangerouslySetInnerHTML: { __html: jo(e, h.customCss) } }) : null,
        /* @__PURE__ */ o(
          "div",
          {
            style: {
            ...
            children: /* @__PURE__ */ o(E, { nodeId: `layout:${e}:block:newsletter`, label: "Email signup", children: /* @__PURE__ */ o("div", { style: S, children: /* @__PURE__ */ m("form", { onSubmit: v, style: H, children: [
              /* @__PURE__ */ o(
                k,
                {
                  fieldPath: `${c}.placeholder`,
...
function Ei(e, t, i) {
  const n = V(e, `templates.${t}.sections`), s = n != null && typeof n == "object" && !Array.isArray(n) ? new Set(Object.keys(n)) : /* @__PURE__ */ new Set(), d = lt(
    e,
    `templates.${t}.section_order`,
    `templates.${t}.sections`,
    i
  ).filter((a) => s.has(a));
  return d.length > 0 ? d : i.filter((a) => s.has(a));
}
function Pe(e, t, i) {
  const n = lt(
    e,
    ...
    `sections.${t}.blocks`,
    i
  ), s = V(e, `sections.${t}.blocks`), u = s != null && typeof s == "object" && !Array.isArray(s) ? s : {};
...
function Re(e, t, i, n) {
  const s = lt(
    ...
    n
  ), u = V(e, `templates.${t}.sections.${i}.blocks`), d = u != null && typeof u == "object" && !Array.isArray(u) ? u : {};
  return s.filter((a) => d[a]?.enabled !== !1);
}
function Bo({ sectionId: e = "header" }) {
  const t = j(), { pathname: i } = xi(), n = B(), { fontHeading: s, fontBody: u, primary: d, background: a } = n, { user: r, logout: p } = Ze(), { getAllItems: c } = xt(), h = c().reduce((se, Ne) => se + Ne.quantity, 0), g = `sections.${e}`, $ = `${g}.settings`, b = `${g}.blocks.logo.settings`, v = `${g}.blocks.menu.settings`, x = F(() => ({
    scheme: Pi(t, $, {
      background: a,
      color: n.text,
      border: R.line
  ...
  const q = L === "always" || L === "on-scroll-up" && J, ve = f && (i === "/" || i === "") && !q, Y = {
    ...
    menu: /* @__PURE__ */ o(
      E,
      {
        ...
        style: {
          display: "flex",
          flexDirection: K === "bottom" ? "column-reverse" : "column",
          alignItems: et(D),
          gap: 8,
  ...
  }, ne = S === "full" ? "100%" : R.maxWidth, he = de ? /* @__PURE__ */ o("span", { style: { ...Y, fontSize: 16 }, title: Oe, "aria-hidden": !0, children: "⌕" }) : null, oe = {
    display: "flex",
    alignItems: "center",
    ...
    je ? r ? /* @__PURE__ */ o(
      "button",
      {
        ...
        children: X === "text" ? "Sign out" : "⎋"
      }
    ) : /* @__PURE__ */ o(I, { to: "/auth/login", style: { color: d, fontWeight: 600, fontSize: 14, textDecoration: "none" }, children: X === "text" ? "Sign in" : "👤" }) : null,
    ye !== "top" && ce === "right" ? he : null
  ] });
        ...
        children: /* @__PURE__ */ m(
          "div",
          {
            style: {
              maxWidth: ne,
              margin: "0 auto",
              padding: `${_}px ${R.padX}px`,
              display: "flex",
              flexDirection: "column",
              gap: 10
            },
            children: [
              K === "top" ? /* @__PURE__ */ o("div", { style: { ...oe, justifyContent: et(D) }, children: Se.menu }) : null,
              /* @__PURE__ */ m("div", { style: oe, children: [
                /* @__PURE__ */ o("div", { style: le, children: Se.logo }),
                K !== "top" && K !== "bottom" ? /* @__PURE__ */ o("div", { style: re, children: Se.menu }) : null,
                Ge
              ] }),
              K === "bottom" ? /* @__PURE__ */ o("div", { style: { ...oe, justifyContent: et(D) }, children: Se.menu }) : null
            ]
          }
        )
      }
...
const tt = "preview-store", Ce = "2026-01-15T12:00:00.000Z", Xe = {
...
}), Ai = [
  {
    _id: "preview_cart_1",
    storeId: tt,
    productVariantId: Tt("preview-variant-1", "Bloom Serum — 30ml", 1299),
    quantity: 1,
    createdAt: Ce
  },
  {
    _id: "preview_cart_2",
    storeId: tt,
    productVariantId: Tt("preview-variant-2", "Velvet Lip Tint — Rose", 899),
    quantity: 2,
    createdAt: Ce
  }
], Ht = {
...
function Ni(e) {
  const t = Xo(e), i = V(e, "layout_order.header");
  if (Array.isArray(i) && i.length > 0) {
    const u = i.map((d) => String(d)).filter((d) => t.has(d));
...
function Oi(e) {
  const t = Xo(e), i = V(e, "layout_order.footer");
  if (Array.isArray(i) && i.length > 0) {
    const s = i.map((u) => String(u)).filter((u) => t.has(u));
...
function Rt(e, t) {
  ...
  if (t === "announcement_bar" || t.startsWith("announcement_bar_"))
    return V(e, `sections.${t}.settings.enabled`) !== !1;
  const i = V(e, `sections.${t}.enabled`);
  return i == null ? !0 : i !== !1;
}
function Gi(e, t, i) {
  if (!e) return !0;
...
function Di(e, t, i, n) {
  const s = l(e, `${t}.headingTypographyPreset`, "heading-2"), u = Mt[s] ?? Mt["heading-2"], d = l(e, `${t}.headingWidth`, "fit"), a = l(e, `${t}.headingMaxWidth`), r = l(e, `${t}.headingColor`, "heading"), p = r === "heading" ? n.heading : r === "accent" ? n.accent : n.text, c = U(e, `${t}.headingBackgroundEnabled`, !1);
  return {
    width: d === "fill" ? "100%" : "fit-content",
    maxWidth: Ft[a] ?? Ft.normal,
    fontFamily: i,
    fontSize: u.fontSize,
...
function Xi(e, t, i) {
  const n = l(e, `${t}.colorScheme`, "scheme-6"), s = Bi[n] ?? i, u = l(e, `${t}.textAlign`, ""), d = l(
    ...
    `${t}.sectionWidth`,
    r ? "full" : "page"
  ), c = l(e, `${t}.height`, ""), h = y(e, `${t}.minHeight`, 0), g = Et[c] ?? (h > 0 ? h : Et.medium), $ = l(e, `${t}.position`, "bottom"), b = $ === "top" ? "flex-start" : $ === "center" || $ === "space-between" ? "center" : "flex-end", v = a === "left" ? "flex-start" : a === "right" ? "flex-end" : "center", z = l(e, `${t}.direction`, "vertical") === "horizontal" ? "row" : "column";
  return {
    scheme: s,
    minHeight: g,
...
function kt({
  ...
  const n = j(), s = B(), { text: u, background: d, primary: a, fontHeading: r, fontBody: p } = s, c = Zi(e, t, i), h = Qi(e, t, i), g = qo(e, t, i), $ = l(n, `${c}.catalogVariant`, ""), b = $ === "hero-bottom-aligned", v = $ === "hero-marquee", x = $ === "large-logo", z = $ === "split-showcase", S = b || v || x || z, _ = !S && !b, H = l(
    n,
    `${c}.marqueeText`,
    l(n, `${c}.subtitle`)
  ), w = l(
    ...
    n,
    L?.textIntro ?? `${c}.eyebrow`,
    ""
  ), W = l(
    n,
    L?.headingMain ?? `${c}.title`,
    "Welcome"
  ), P = l(n, `${c}.subtitle`, ""), C = l(
    n,
    L?.textBody ?? `${h}.text_2.settings.text`,
    ""
    ...
    [a, d, f.scheme.color]
  ), D = b ? ["content_group"] : v ? ["primary_button"] : x ? ["text_2"] : z ? ["heading", "text_right", "primary_button", "secondary_button"] : ["heading", "primary_button"], K = t === "layout" ? Pe(n, e, D) : Re(n, i, e, D), te = qi(e, f.customCss), X = Vi(e, f.mobileStackMedia, f.mobileDifferentMedia), de = f.overlayStyle === "gradient" ? f.overlayGradientDirection === "down" ? `linear-gradient(180deg, transparent 0%, ${f.overlayColor} 100%)` : `linear-gradient(180deg, ${f.overlayColor} 0%, transparent 100%)` : f.overlayColor, ce = !!(f.media1Url || f.media2Url), ye = {
  ...
  }, Ue = (A = !1) => K.map((J) => /* @__PURE__ */ o("span", { style: { display: "contents" }, children: Oe(J, A) }, J)), je = Math.max(200, f.minHeight - f.paddingTop - f.paddingBottom), xe = typeof f.maxWidth == "number" ? f.maxWidth : f.maxWidth === "100%" ? "100%" : 1200, Me = "#ffffff", ke = () => {
    if (!L) return null;
    ...
    "div",
    {
      ...
      children: v ? ge : ce && f.direction === "row" ? /* @__PURE__ */ m(ae, { children: [
  ...
  if (b) {
    ...
    return /* @__PURE__ */ m(ae, { children: [
      ...
      X ? /* @__PURE__ */ o("style", { children: X }) : null,
      /* @__PURE__ */ m(
        O,
        {
          sectionId: e,
  ...
  if (x) {
    const A = l(n, `${h}.text_2.settings.text`, "") || P || C, J = W.trim() || "My Store", Q = Math.max(f.paddingTop, 40), q = Math.max(f.paddingBottom, 48), ee = 40, ve = f.minHeight, Y = l(n, `${c}.backgroundMedia`, "none"), Se = l(n, `${c}.backgroundImageUrl`, ""), ne = Y === "image" && !!Se.trim(), he = l(n, `${c}.borderStyle`, "none"), oe = y(n, `${c}.cornerRadius`, 0), le = l(n, `${c}.defaultLogoUrl`, ""), re = he === "solid" ? `1px solid ${f.scheme.muted}55` : void 0, De = f.mediaOverlay && ne ? f.overlayStyle === "gradient" ? f.overlayGradientDirection === "down" ? `linear-gradient(180deg, transparent 0%, ${f.overlayColor} 100%)` : `linear-gradient(180deg, ${f.overlayColor} 0%, transparent 100%)` : f.overlayColor : void 0, Ge = /* @__PURE__ */ m(
      "div",
      {
        style: {
          position: "relative",
        ...
        children: [
          ...
          /* @__PURE__ */ o(
            "div",
            {
              ...
              children: le.trim() ? /* @__PURE__ */ o(k, { fieldPath: `${c}.defaultLogoUrl`, label: "Default logo", as: "div", children: /* @__PURE__ */ o(
                "img",
                {
                  src: le,
                  alt: J,
      ...
      /* @__PURE__ */ m(
        O,
        {
          ...
          style: {
            ...
            minHeight: ve,
            padding: 0,
            background: ne ? f.scheme.background : f.scheme.background || "#f0f1ed",
            fontFamily: p,
            color: "#111827",
            boxSizing: "border-box"
          },
  ...
  if (z) {
    const A = f.media1Url.trim() || Ki, J = f.media2Url.trim() || Yi, Q = f.minHeight, q = U(n, `${c}.verticalOnMobile`, !0), ee = l(n, `${c}.backgroundMedia`, "none"), ve = l(n, `${c}.backgroundImageUrl`, ""), Y = ee === "image" && !!ve.trim(), Se = l(n, `${c}.borderStyle`, "none"), ne = y(n, `${c}.cornerRadius`, 0), he = Se === "solid" ? `1px solid ${f.scheme.muted}55` : void 0, oe = Ii(e, q), le = f.mediaOverlay && A ? f.overlayStyle === "gradient" ? f.overlayGradientDirection === "down" ? `linear-gradient(180deg, transparent 0%, ${f.overlayColor} 100%)` : `linear-gradient(180deg, ${f.overlayColor} 0%, transparent 100%)` : f.overlayColor : void 0, re = f.mediaOverlay && Y ? `linear-gradient(180deg, transparent 0%, ${f.overlayColor} 100%)` : void 0, De = {
      margin: 0,
      fontFamily: r,
...
function Io({
  ...
  const n = j(), { fontBody: s, fontHeading: u } = B(), [d, a] = Z(""), [r, p] = Z(""), [c, h] = Z(""), [g, $] = Z(""), b = i === "template" ? `templates.${t}.sections.${e}.settings` : `sections.${e}.settings`, v = i === "template" ? `template:${t}:${e}` : `layout:${e}`, x = F(() => tn(n, b), [n, b]), z = l(n, `${b}.title`), S = l(n, `${b}.namePlaceholder`), _ = l(n, `${b}.emailPlaceholder`), H = l(n, `${b}.phonePlaceholder`), w = l(n, `${b}.commentPlaceholder`), L = l(n, `${b}.submitLabel`), T = x.colorScheme, W = x.sectionWidth === "full" ? "100%" : R.maxWidth, P = x.sectionWidth === "full" ? 24 : R.padX, C = x.alignment === "left" ? "left" : x.alignment === "right" ? "right" : "center", M = x.position === "top" ? "flex-start" : x.position === "bottom" ? "flex-end" : "center", f = Math.max(x.cornerRadius > 0 ? x.cornerRadius : 8, 0), G = {
    width: "100%",
    boxSizing: "border-box",
    fontFamily: s,
    fontSize: 15,
  ...
  return /* @__PURE__ */ m(O, { sectionId: e, editorNodeId: v, label: "Contact form", style: D, children: [
    ...
    /* @__PURE__ */ m("div", { style: { ...K, position: "relative", zIndex: 2 }, children: [
      /* @__PURE__ */ o(
        k,
        {
          fieldPath: `${b}.title`,
      ...
      /* @__PURE__ */ m("form", { onSubmit: N, style: te, children: [
        ...
        /* @__PURE__ */ o("div", { style: { marginBottom: 16 }, children: /* @__PURE__ */ o(k, { fieldPath: `${b}.commentPlaceholder`, label: "Comment placeholder", as: "span", children: /* @__PURE__ */ o(
          "textarea",
          {
            ...
            placeholder: w,
            rows: 5,
            style: { ...G, resize: "vertical", minHeight: 120 },
            "aria-label": w
          }
        ) }) }),
...
function Vo({
  ...
  const n = j(), { fontBody: s, fontHeading: u } = B(), [d, a] = Z(""), r = i === "template" ? `templates.${t}.sections.${e}.settings` : `sections.${e}.settings`, p = i === "template" ? `template:${t}:${e}` : `layout:${e}`, c = F(() => ln(n, r), [n, r]), h = l(n, `${r}.title`), g = l(n, `${r}.subtitle`), $ = l(n, `${r}.placeholder`), b = l(n, `${r}.buttonLabel`), v = c.colorScheme, x = c.sectionWidth === "full" ? "100%" : R.maxWidth, z = c.sectionWidth === "full" ? 24 : R.padX, S = c.alignment === "left" ? "left" : c.alignment === "right" ? "right" : "center", _ = c.position === "top" ? "flex-start" : c.position === "bottom" ? "flex-end" : "center", H = 100, w = (f) => {
    f.preventDefault(), a("");
  }, L = {
    position: "relative",
  ...
  return /* @__PURE__ */ m(O, { sectionId: e, editorNodeId: p, label: "Email signup", style: L, children: [
...
function an(e, t) {
  const i = l(e, `${t}.colorScheme`, "scheme-1"), n = l(e, `${t}.height`, "small"), s = l(e, `${t}.direction`, "vertical"), u = l(e, `${t}.layoutAlignment`, "left"), d = y(e, `${t}.minHeight`, 0), a = Ot[n];
  return {
    direction: s === "horizontal" ? "horizontal" : "vertical",
    alignment: u === "left" || u === "right" ? u : "center",
    position: ["top", "bottom"].includes(l(e, `${t}.position`, "center")) ? l(e, `${t}.position`, "center") : "center",
...
function vt({ sectionId: e, placement: t = "template", templateId: i = "index" }) {
  const n = j(), { fontBody: s } = B(), u = t === "template" ? `templates.${i}.sections.${e}.settings` : `sections.${e}.settings`, d = t === "template" ? `template:${i}:${e}` : `layout:${e}`, a = F(() => an(n, u), [n, u]), r = a.colorScheme, p = a.sectionWidth === "full" ? "100%" : R.maxWidth, c = a.sectionWidth === "full" ? 24 : R.padX, h = a.alignment === "left" ? "left" : a.alignment === "right" ? "right" : "center", g = a.position === "top" ? "flex-start" : a.position === "bottom" ? "flex-end" : "center", $ = {
    position: "relative",
  ...
  return /* @__PURE__ */ m(O, { sectionId: e, editorNodeId: d, label: "Custom section", style: $, children: [
...
function sn({
  ...
  const n = j(), { fontBody: s, fontHeading: u } = B(), { storeFrontMeta: d } = it(), { products: a, fetchProductsByStoreId: r, fetchProductById: p, productDetail: c } = ht(), h = i === "template" ? `templates.${t}.sections.${e}.settings` : `sections.${e}.settings`, g = i === "template" ? `template:${t}:${e}` : `layout:${e}`, $ = F(() => Yo(n, h), [n, h]), b = l(n, `${h}.productId`, ""), v = l(n, `${h}.productTitle`), x = l(n, `${h}.price`), z = l(n, `${h}.productImageUrl`, ""), S = l(n, `${h}.mediaPosition`, "left"), _ = U(n, `${h}.showRating`, !0), H = y(n, `${h}.rating`, 4.5), w = y(n, `${h}.reviewCount`, 3), L = U(n, `${h}.showTaxNote`, !0), T = l(n, `${h}.taxNote`), W = l(n, `${h}.buttonLabel`), P = U(n, `${h}.soldOut`, !0), C = d?.storeId ?? "";
  ue(() => {
  ...
  const M = F(() => b ? c?._id === b ? c : a.find((ge) => ge._id === b) ?? null : null, [b, c, a]), f = M?.title ?? v, G = M ? Ye(M.price) : x, N = M?.imageUrls?.[0] ?? z, D = $.scheme, K = S !== "right", te = $.sectionWidth === "full" ? "100%" : R.maxWidth, X = $.sectionWidth === "full" ? 24 : R.padX, de = $.equalColumns ? "1fr 1fr" : "1.05fr 0.95fr", ce = {
    background: D.background,
    color: D.color,
    fontFamily: s,
  ...
  return /* @__PURE__ */ m(O, { nodeId: g, label: "Featured product", style: ce, children: [
    $.customCss ? /* @__PURE__ */ o("style", { dangerouslySetInnerHTML: { __html: Zo(e, $.customCss) } }) : null,
    /* @__PURE__ */ o("div", { style: ye, "data-ziplofy-section": e, children: /* @__PURE__ */ m("div", { style: Oe, children: [
      ...
      /* @__PURE__ */ m("div", { style: je, children: [
        ...
        L ? /* @__PURE__ */ o(k, { nodeId: g, fieldPath: `${h}.taxNote`, label: "Tax note", as: "p", style: Fe, children: T }) : null,
...
function Qo({
  ...
  const n = j(), { fontBody: s, fontHeading: u } = B(), { storeFrontMeta: d } = it(), { products: a, fetchProductsByStoreId: r, fetchProductById: p, productDetail: c } = ht(), h = i === "template" ? `templates.${t}.sections.${e}.settings` : `sections.${e}.settings`, g = i === "template" ? `template:${t}:${e}` : `layout:${e}`;
  ...
  const b = F(() => Yo(n, h), [n, h]), v = l(n, `${h}.productId`, ""), x = l(n, `${h}.productTitle`), z = l(n, `${h}.price`), S = l(n, `${h}.productImageUrl`, ""), _ = l(n, `${h}.mediaPosition`, "left"), H = d?.storeId ?? "";
  ue(() => {
  ...
  const w = F(() => v ? c?._id === v ? c : a.find((ye) => ye._id === v) ?? null : null, [v, c, a]), L = w?.title ?? x, T = w ? Ye(w.price) : z, W = w?.imageUrls?.[0] ?? S, P = b.scheme, C = R.maxWidth, M = R.padX, f = _ !== "right", G = {
    ...
    paddingTop: 16,
    paddingBottom: 8
  }, de = /* @__PURE__ */ o("div", { style: D, children: /* @__PURE__ */ o(St, {}) }), ce = /* @__PURE__ */ m("div", { style: K, children: [
    ...
    /* @__PURE__ */ o("div", { style: X, children: /* @__PURE__ */ o(k, { fieldPath: `${h}.productImageUrl`, label: "Product image", as: "span", children: W ? /* @__PURE__ */ o(
      "img",
      {
        src: W,
        alt: "",
  ...
  return /* @__PURE__ */ m(O, { sectionId: e, editorNodeId: g, label: "Product highlight", style: G, children: [
    b.customCss ? /* @__PURE__ */ o("style", { dangerouslySetInnerHTML: { __html: Zo(e, b.customCss) } }) : null,
...
function un({ sectionId: e }) {
  return /* @__PURE__ */ o(Qo, { sectionId: e, placement: "layout" });
}
function hn() {
  return /* @__PURE__ */ m(
    "div",
...
function mn(e) {
  const [t, i] = Dt[e] ?? Dt.medium;
  return `${t} ${i}`;
}
function gn(e) {
  return Bt[e] ?? Bt.medium;
}
function fn(e, t) {
  const i = t.trim();
  return i ? i.replace(/:root/g, `[data-ziplofy-section="${e}"]`) : "";
...
function Jo({
  ...
  const n = j(), { fontBody: s, fontHeading: u } = B(), d = i === "template" ? `templates.${t}.sections.${e}.settings` : `sections.${e}.settings`, a = i === "template" ? `template:${t}:${e}` : `layout:${e}`, r = F(() => pn(n, d), [n, d]), p = l(n, `${d}.imageUrl`, ""), c = l(n, `${d}.subheading`), h = l(n, `${d}.heading`), g = l(
    n,
    `${d}.description`,
    "Made with care and unconditionally loved by our customers, this signature bestseller exceeds all expectations."
  ), $ = l(n, `${d}.linkLabel`), b = l(n, `${d}.linkUrl`), v = l(n, `${d}.mediaPosition`, "left"), x = r.scheme, z = v !== "right", S = gn(r.mediaHeight), _ = r.sectionWidth === "full" ? 24 : R.padX, H = r.sectionWidth === "full" ? "100%" : R.maxWidth;
  let w = mn(r.mediaWidth);
  if (!z) {
    const K = w.split(" ");
    K.length === 2 && (w = `${K[1]} ${K[0]}`);
  }
  const L = {
    ...
    /* @__PURE__ */ o(k, { fieldPath: `${d}.linkLabel`, label: "Link label", as: "span", children: b ? /* @__PURE__ */ o(I, { to: b, style: G, children: $ }) : /* @__PURE__ */ o("span", { style: G, children: $ }) })
  ] });
  return /* @__PURE__ */ m(O, { sectionId: e, editorNodeId: a, label: "Editorial", style: L, children: [
...
function ei({
  ...
  const n = j(), { fontBody: s, fontHeading: u } = B(), d = i === "template" ? `templates.${t}.sections.${e}.settings` : `sections.${e}.settings`, a = i === "template" ? `template:${t}:${e}` : `layout:${e}`, r = F(() => xn(n, d), [n, d]), p = l(n, `${d}.headline`), c = l(n, `${d}.imageUrl`, ""), h = wn(n, d), g = Sn(p), $ = r.scheme, b = h !== "right", v = kn(r.mediaHeight), x = r.sectionWidth === "full" ? 24 : R.padX, z = r.sectionWidth === "full" ? "100%" : R.maxWidth;
  ...
  const _ = {
    ...
    color: $.color,
    maxWidth: "100%"
  }, W = /* @__PURE__ */ o("div", { style: w, children: /* @__PURE__ */ o(k, { fieldPath: `${d}.headline`, label: "Headline", as: "div", style: T, children: g.map((C, M) => /* @__PURE__ */ o("span", { style: { display: "block" }, children: C }, `${C}-${M}`)) }) }), P = /* @__PURE__ */ o("div", { style: L, children: /* @__PURE__ */ o(k, { fieldPath: `${d}.imageUrl`, label: "Image", as: "span", children: c ? /* @__PURE__ */ o(
    "img",
    {
      src: c,
      alt: "",
  ...
  return /* @__PURE__ */ m(O, { sectionId: e, editorNodeId: a, label: "Editorial: Jumbo text", style: _, children: [
    r.customCss ? /* @__PURE__ */ o("style", { dangerouslySetInnerHTML: { __html: vn(e, r.customCss) } }) : null,
    /* @__PURE__ */ o("div", { style: H, children: b ? /* @__PURE__ */ m(ae, { children: [
      P,
      W
    ] }) : /* @__PURE__ */ m(ae, { children: [
      W,
...
function ti({
  ...
  const n = j(), { fontBody: s, fontHeading: u } = B(), d = i === "template" ? `templates.${t}.sections.${e}.settings` : `sections.${e}.settings`, a = i === "template" ? `template:${t}:${e}` : `layout:${e}`, r = F(() => Tn(n, d), [n, d]), p = l(n, `${d}.heading`), c = l(n, `${d}.subheading`), h = l(n, `${d}.button1Label`), g = l(n, `${d}.button1Url`), $ = l(n, `${d}.button2Label`), b = l(n, `${d}.button2Url`), v = l(n, `${d}.imageBeforeUrl`, ""), x = l(n, `${d}.imageAfterUrl`, ""), z = r.scheme, S = Hn(r.height), _ = r.sectionWidth === "full" ? 24 : R.padX, H = r.sectionWidth === "full" ? "100%" : R.maxWidth, w = r.direction === "horizontal", L = {
    position: "relative",
    ...
    minHeight: S,
    width: "100%",
    alignItems: Ln(r.position),
    justifyContent: Rn(r.layoutAlignment)
  ...
  ) }) }), K = r.backgroundMedia === "image" && r.backgroundImageUrl ? r.backgroundImageUrl : null;
  return /* @__PURE__ */ m(O, { sectionId: e, editorNodeId: a, label: "Image compare", style: L, children: [
    K ? /* @__PURE__ */ o(
      "div",
      {
        "aria-hidden": !0,
    ...
    W ? /* @__PURE__ */ o("style", { children: `
        ...
        ` }) : null,
    /* @__PURE__ */ o("div", { className: W || void 0, style: { ...T, position: "relative", zIndex: 1 }, children: r.compareFirst ? /* @__PURE__ */ m(ae, { children: [
      D,
      N
    ] }) : /* @__PURE__ */ m(ae, { children: [
      N,
...
function oi({
  ...
  const n = j(), { fontBody: s, fontHeading: u } = B(), d = i === "template" ? `templates.${t}.sections.${e}.settings` : `sections.${e}.settings`, a = i === "template" ? `template:${t}:${e}` : `layout:${e}`, r = F(() => Un(n, d), [n, d]), p = l(n, `${d}.imageUrl`, ""), c = l(n, `${d}.heading`), h = l(
    n,
    `${d}.description`,
    "Made with care and unconditionally loved by our customers, this signature bestseller exceeds all expectations."
  ), g = l(
    ...
    `${d}.buttonUrl`,
    l(n, `${d}.linkUrl`)
  ), b = r.scheme, v = Nn(r.height), x = r.sectionWidth === "full" ? 24 : R.padX, z = r.sectionWidth === "full" ? "100%" : R.maxWidth, S = r.direction === "horizontal", _ = {
    position: "relative",
  ...
  }, w = r.verticalOnMobile && S ? `ziplofy-image-with-text-stack-${e.replace(/[^a-z0-9_-]/gi, "-")}` : "", L = {
    ...
    color: b.muted,
    maxWidth: 420
  }, C = /* @__PURE__ */ o("div", { style: L, children: /* @__PURE__ */ o(k, { fieldPath: `${d}.imageUrl`, label: "Image", as: "span", children: p ? /* @__PURE__ */ o(
    "img",
    {
      src: p,
      alt: "",
    ...
    /* @__PURE__ */ o(k, { fieldPath: `${d}.buttonLabel`, label: "Button", as: "span", children: $ ? /* @__PURE__ */ o(I, { to: $, style: Zt, children: g }) : /* @__PURE__ */ o("span", { style: Zt, children: g }) })
  ] }), f = r.backgroundMedia === "image" && r.backgroundImageUrl ? r.backgroundImageUrl : null;
  return /* @__PURE__ */ m(O, { sectionId: e, editorNodeId: a, label: "Image with text", style: _, children: [
    f ? /* @__PURE__ */ o(
      "div",
      {
        "aria-hidden": !0,
    ...
    w ? /* @__PURE__ */ o("style", { children: `
        ...
        ` }) : null,
    /* @__PURE__ */ o("div", { className: w || void 0, style: { ...H, position: "relative", zIndex: 1 }, children: r.imageFirst ? /* @__PURE__ */ m(ae, { children: [
      C,
      M
    ] }) : /* @__PURE__ */ m(ae, { children: [
      M,
...
function wt({ sectionId: e, placement: t = "layout", templateId: i = "index" }) {
  const n = j(), { fontBody: s } = B(), u = t === "template" ? `templates.${i}.sections.${e}.settings` : `sections.${e}.settings`, d = t === "template" ? `template:${i}:${e}` : `layout:${e}`, a = F(() => Bn(n, u), [n, u]), r = a.widthMode === "full" ? "100%" : R.maxWidth, p = a.widthMode === "full" ? 24 : R.padX, c = Math.max(a.thickness, 1), h = {
  ...
  return /* @__PURE__ */ m(O, { sectionId: e, editorNodeId: d, label: "Divider", style: h, children: [
...
function Vn(e, t, i, n) {
  const u = `${n === "template" ? `templates.${t}.sections.${i}` : `sections.${i}`}.blocks`, d = n === "template" ? Re(e, t, i, []) : Pe(e, i, []), a = V(e, u);
...
function ii({
  ...
  const n = j(), s = i === "template" ? `templates.${t}.sections.${e}.settings` : `sections.${e}.settings`, u = i === "template" ? `template:${t}:${e}` : `layout:${e}`, d = F(() => In(n, s), [n, s]), a = F(
    () => Vn(n, t, e, i),
    [n, t, e, i]
  ), r = l(n, `${s}.heading`), [p, c] = Z(() => d.openFirstItem && a[0] ? /* @__PURE__ */ new Set([a[0].id]) : /* @__PURE__ */ new Set()), h = d.scheme, g = d.sectionWidth === "full" ? 24 : R.padX, $ = d.sectionWidth === "full" ? "100%" : R.maxWidth, b = `ziplofy-faq-${e.replace(/[^a-z0-9_-]/gi, "-")}`, v = d.layoutAlignment, x = {
    position: "relative",
  ...
  return /* @__PURE__ */ m(O, { sectionId: e, label: "FAQ", editorNodeId: u, style: x, children: [
...
function ni({
  ...
  const n = j(), s = i === "template" ? `templates.${t}.sections.${e}.settings` : `sections.${e}.settings`, u = i === "template" ? `template:${t}:${e}` : `layout:${e}`, d = F(
    ...
    () => tl(n, t, e, i),
    [n, t, e, i]
  ), r = d.scheme, p = d.sectionWidth === "full" ? 24 : R.padX, c = d.sectionWidth === "full" ? "100%" : R.maxWidth, h = `ziplofy-icons-with-text-${e.replace(/[^a-z0-9_-]/gi, "-")}`, g = Math.max(a.length, d.columns), $ = d.direction === "horizontal", b = d.verticalOnMobile && $ ? `ziplofy-icons-with-text-stack-${e.replace(/[^a-z0-9_-]/gi, "-")}` : "", v = {
    position: "relative",
    background: r.background,
    color: r.color,
    paddingTop: d.paddingTop,
    ...
    color: r.muted,
    maxWidth: 280
  }, w = ol(e, d.customCss), L = b ? il(e) : "", T = s.replace(/\.settings$/, "");
  return /* @__PURE__ */ m(O, { sectionId: e, label: "Icons with text", editorNodeId: u, style: v, children: [
...
function li({
  ...
  const n = j(), s = i === "template" ? `templates.${t}.sections.${e}.settings` : `sections.${e}.settings`, u = i === "template" ? `template:${t}:${e}` : `layout:${e}`, d = F(() => rl(n, s), [n, s]), a = F(
    () => al(n, t, e, i),
    [n, t, e, i]
  ), r = d.scheme, p = d.sectionWidth === "full" ? 24 : R.padX, c = d.sectionWidth === "full" ? "100%" : R.maxWidth, h = `ziplofy-multicolumn-${e.replace(/[^a-z0-9_-]/gi, "-")}`, g = Math.max(a.length, d.columns), $ = d.direction === "horizontal", b = d.verticalOnMobile && $ ? `ziplofy-multicolumn-stack-${e.replace(/[^a-z0-9_-]/gi, "-")}` : "", v = {
    position: "relative",
    background: r.background,
    color: r.color,
    paddingTop: d.paddingTop,
    ...
    color: r.muted,
    maxWidth: 320
  }, w = dl(e, d.customCss), L = b ? cl(e) : "", T = s.replace(/\.settings$/, "");
  return /* @__PURE__ */ m(O, { sectionId: e, label: "Multicolumn", editorNodeId: u, style: v, children: [
    w ? /* @__PURE__ */ o("style", { children: w }) : null,
    L ? /* @__PURE__ */ o("style", { children: L }) : null,
    x ? /* @__PURE__ */ o(
      "div",
...
function ri({
  ...
  const n = j(), { fontHeading: s } = B(), u = i === "template" ? `templates.${t}.sections.${e}.settings` : `sections.${e}.settings`, d = i === "template" ? `template:${t}:${e}` : `layout:${e}`, a = F(() => ul(n, u), [n, u]), r = l(n, `${u}.quote`), p = l(n, `${u}.linkLabel`), c = l(n, `${u}.linkUrl`), h = a.scheme, g = _t(a.layoutAlignment), $ = a.sectionWidth === "full" ? 24 : R.padX, b = a.sectionWidth === "full" ? "100%" : R.maxWidth, v = `ziplofy-pull-quote-${e.replace(/[^a-z0-9_-]/gi, "-")}`, x = {
    position: "relative",
  ...
  return /* @__PURE__ */ m(O, { sectionId: e, label: "Pull quote", editorNodeId: d, style: x, children: [
    L ? /* @__PURE__ */ o("style", { children: L }) : null,
    z ? /* @__PURE__ */ o(
      "div",
      {
...
function ai({
  ...
  return /* @__PURE__ */ m(O, { sectionId: e, label: "Rich text", editorNodeId: a, style: _, children: [
    ...
    /* @__PURE__ */ m("div", { className: z, style: w, children: [
      p ? /* @__PURE__ */ o(k, { fieldPath: `${d}.heading`, label: "Heading", as: "h2", style: L, children: p }) : null,
...
function di({
  ...
  const n = j(), { fontBody: s } = B(), u = i === "template" ? `templates.${t}.sections.${e}.settings` : `sections.${e}.settings`, d = i === "template" ? `template:${t}:${e}` : `layout:${e}`, a = F(() => fl(n, u), [n, u]), r = l(n, `${u}.text`), p = `ziplofy-text-marquee-${e.replace(/[^a-z0-9_-]/gi, "-")}`, c = a.motionDirection === "reverse" ? "ziplofy-marquee-reverse" : "ziplofy-marquee-forward", h = {
    position: "relative",
    background: a.scheme.background,
    color: a.scheme.color,
    paddingTop: a.paddingTop,
  ...
  return /* @__PURE__ */ o(O, { nodeId: d, label: "Marquee", children: /* @__PURE__ */ m("section", { className: p, style: h, "data-section-type": "text-marquee", children: [
    /* @__PURE__ */ o("style", { children: `
...
function xl(e, t) {
  const i = l(e, `${t}.colorScheme`, "scheme-1"), n = lo[i] ?? lo["scheme-1"], s = l(e, `${t}.sectionWidth`, "page"), u = l(e, `${t}.layoutAlignment`, "center"), d = l(e, `${t}.logoFont`, "heading");
...
function ci({
  ...
  const n = j(), { fontHeading: s, fontBody: u } = B(), d = i === "template" ? `templates.${t}.sections.${e}.settings` : `sections.${e}.settings`, a = i === "template" ? `template:${t}:${e}` : `layout:${e}`, r = F(
    () => xl(n, d),
    [n, d]
  ), p = l(n, `${d}.logoText`), c = l(n, `${d}.logoImageUrl`, ""), h = l(n, `${d}.logoLinkUrl`, "/"), g = r.scheme, $ = r.sectionWidth === "full" ? 24 : R.padX, b = r.sectionWidth === "full" ? "100%" : R.maxWidth, v = `ziplofy-storytelling-logo-${e.replace(/[^a-z0-9_-]/gi, "-")}`, x = kl(r), z = $l(r.layoutAlignment), S = {
    position: "relative",
    background: g.background,
    color: g.color,
    paddingTop: r.paddingTop,
  ...
  ) }) : /* @__PURE__ */ o(k, { fieldPath: `${d}.logoText`, label: "Logo text", as: "span", style: H, children: p }), L = h && h !== "#" ? /* @__PURE__ */ o(I, { to: h, style: { display: "inline-flex", textDecoration: "none", color: "inherit" }, children: w }) : w, T = vl(e, r.customCss);
  return /* @__PURE__ */ o(O, { nodeId: a, label: "Logo", children: /* @__PURE__ */ m("section", { className: v, style: S, "data-section-type": "storytelling-logo", children: [
    T ? /* @__PURE__ */ o("style", { children: T }) : null,
    /* @__PURE__ */ o("div", { style: _, children: L })
  ] }) });
}
function _l() {
...
function si({
  ...
  const n = j(), { fontBody: s } = B(), u = i === "template" ? `templates.${t}.sections.${e}.settings` : `sections.${e}.settings`, d = i === "template" ? `template:${t}:${e}` : `layout:${e}`, a = F(
    () => Wl(n, u),
    [n, u]
  ...
  ), g = l(n, `${u}.linkLabel`), $ = l(n, `${u}.linkUrl`), b = a.scheme, v = Pl(a.height), x = a.sectionWidth === "full" ? 24 : R.padX, z = a.sectionWidth === "full" ? "100%" : R.maxWidth, S = a.videoOnRight, _ = a.direction === "horizontal", H = `ziplofy-storytelling-video-${e.replace(/[^a-z0-9_-]/gi, "-")}`, w = {
    position: "relative",
    background: b.background,
    color: b.color,
    fontFamily: s,
    ...
    gap: a.layoutGap,
    alignItems: _ ? ao(a.position) : "stretch",
    ...
    alignSelf: _ ? ao(a.position) : void 0,
    boxSizing: "border-box",
    position: "relative",
    zIndex: 3,
    order: _ && !S ? 1 : _ ? 0 : 1,
  ...
  return /* @__PURE__ */ o(O, { nodeId: d, label: "Video", children: /* @__PURE__ */ m("section", { className: H, style: w, "data-section-type": "storytelling-video", children: [
    ...
    /* @__PURE__ */ m("div", { style: L, children: [
      /* @__PURE__ */ o("div", { style: T, children: /* @__PURE__ */ m(k, { fieldPath: `${u}.coverImageUrl`, label: "Cover image", as: "div", style: W, children: [
        M,
        /* @__PURE__ */ o("div", { style: P, children: /* @__PURE__ */ o(Rl, {}) })
      ] }) }),
      /* @__PURE__ */ m("div", { style: C, children: [
        /* @__PURE__ */ o(k, { fieldPath: `${u}.caption`, label: "Caption", as: "p", style: Ll, children: h }),
        /* @__PURE__ */ o(k, { fieldPath: `${u}.linkLabel`, label: "Link", as: "span", children: $ ? /* @__PURE__ */ o(I, { to: $, style: co, children: g }) : /* @__PURE__ */ o("span", { style: co, children: g }) })
      ] })
    ] })
  ] }) });
}
...
function Il({ sectionId: e = "footer_utilities" }) {
  const t = j(), { text: i, fontBody: n } = B(), s = `sections.${e}.settings`, u = `sections.${e}.blocks`, a = ql(t, s) === "policies-links", r = F(() => ({
    scheme: Al(t, s, {
      background: "#f3f4f6",
      color: i,
      muted: "#6b7280",
  ...
  }, _ = `${u}.social.settings`, w = Pe(t, e, a ? ["copyright", "policy_links"] : ["copyright", "policy_links", "social"]), L = {
  ...
  }, T = r.widthMode === "full" ? "100%" : R.maxWidth, W = r.widthMode === "full" ? 0 : R.padX;
  return /* @__PURE__ */ m(
    O,
    {
      sectionId: e,
...
function Vl(e) {
  return hi(e) ? !1 : e === "footer" || /^footer_\d+$/.test(e);
}
function Kl({ sectionId: e }) {
  return hi(e) ? /* @__PURE__ */ o(Il, { sectionId: e }) : Vl(e) ? /* @__PURE__ */ o(Do, { sectionId: e }) : e === "divider" || e.startsWith("divider_") ? /* @__PURE__ */ o(wt, { sectionId: e, placement: "layout" }) : e === "custom_section" || e.startsWith("custom_section_") ? /* @__PURE__ */ o(vt, { sectionId: e, placement: "layout" }) : e === "hero_main" || e.startsWith("hero_main_") ? /* @__PURE__ */ o(kt, { sectionId: e, placement: "layout" }) : e === "product_highlight" || e.startsWith("product_highlight_") ? /* @__PURE__ */ o(un, { sectionId: e }) : e === "image_compare" || e.startsWith("image_compare_") ? /* @__PURE__ */ o(Fn, { sectionId: e }) : e === "image_with_text" || e.startsWith("image_with_text_") ? /* @__PURE__ */ o(Dn, { sectionId: e }) : e === "editorial_jumbo" || e.startsWith("editorial_jumbo_") ? /* @__PURE__ */ o(_n, { sectionId: e }) : e === "editorial" || e.startsWith("editorial_") ? /* @__PURE__ */ o(bn, { sectionId: e }) : e === "faq_section" || e.startsWith("faq_section_") ? /* @__PURE__ */ o(ii, { sectionId: e, placement: "layout" }) : e === "icons_with_text" || e.startsWith("icons_with_text_") ? /* @__PURE__ */ o(ni, { sectionId: e, placement: "layout" }) : e === "multicolumn_section" || e.startsWith("multicolumn_section_") ? /* @__PURE__ */ o(li, { sectionId: e, placement: "layout" }) : e === "pull_quote_section" || e.startsWith("pull_quote_section_") ? /* @__PURE__ */ o(ri, { sectionId: e, placement: "layout" }) : e === "rich_text_section" || e.startsWith("rich_text_section_") ? /* @__PURE__ */ o(ai, { sectionId: e, placement: "layout" }) : e === "text_marquee_section" || e.startsWith("text_marquee_section") ? /* @__PURE__ */ o(di, { sectionId: e, placement: "layout" }) : e === "contact_form" || e.startsWith("contact_form") ? /* @__PURE__ */ o(Io, { sectionId: e, placement: "layout" }) : e === "email_signup" || e.startsWith("email_signup") ? /* @__PURE__ */ o(Vo, { sectionId: e, placement: "layout" }) : e === "storytelling_logo" || e.startsWith("storytelling_logo") ? /* @__PURE__ */ o(ci, { sectionId: e, placement: "layout" }) : e === "storytelling_video" || e.startsWith("storytelling_video") ? /* @__PURE__ */ o(si, { sectionId: e, placement: "layout" }) : null;
}
const Yl = {
...
function lr({ sectionId: e = "announcement_bar" }) {
  const t = j(), i = B(), n = rt(), s = gi(), u = fi(s, e), d = {
  ...
  const z = Zl(t, r, d), S = Ql(t, r), { paddingTop: _, paddingBottom: H } = Jl(t, r), w = er(t, r), L = l(t, `${r}.customCss`, ""), T = or(e, L), W = (C, M) => {
    const f = ir(C.typography), G = `${a}.blocks.${C.blockId}.settings.text`, N = `${a}.blocks.${C.blockId}.settings.link`, D = /* @__PURE__ */ o(k, { fieldPath: G, label: "Text", children: /* @__PURE__ */ o("span", { style: f, children: C.text }) }), K = C.link && C.link.startsWith("/") ? /* @__PURE__ */ m(I, { to: C.link, style: { color: z.color, textDecoration: "none" }, children: [
      D,
      /* @__PURE__ */ o(
        "span",
        {
    ...
    return /* @__PURE__ */ o(
      "div",
      {
        ...
        "aria-hidden": !M,
        children: c.includes(C.blockId) ? /* @__PURE__ */ o(E, { nodeId: `layout:${e}:block:${C.blockId}`, label: "Announcement", children: K }) : /* @__PURE__ */ o(k, { fieldPath: `${r}.message`, label: "Announcement text", children: /* @__PURE__ */ o("span", { style: f, children: C.text }) })
      },
      C.blockId
    );
  }, P = n && h.length > 1;
...
function rr({ sectionId: e }) {
  return e === "header" || e.startsWith("header_") ? /* @__PURE__ */ o(Bo, { sectionId: e }) : e === "announcement_bar" || e.startsWith("announcement_bar_") ? /* @__PURE__ */ o(lr, { sectionId: e }) : e === "divider" || e.startsWith("divider_") ? /* @__PURE__ */ o(wt, { sectionId: e, placement: "layout" }) : e === "custom_section" || e.startsWith("custom_section_") ? /* @__PURE__ */ o(vt, { sectionId: e, placement: "layout" }) : null;
}
function Ae({ children: e }) {
  const t = j(), { background: i, text: n } = B(), s = Ni(t), u = Oi(t);
  return /* @__PURE__ */ m("div", { style: { minHeight: "100vh", background: i, color: n }, children: [
    s.map(
      (d) => Rt(t, d) ? /* @__PURE__ */ o(rr, { sectionId: d }, d) : null
    ),
    /* @__PURE__ */ o("main", { children: e }),
    u.map(
      (d) => Rt(t, d) ? /* @__PURE__ */ o(Kl, { sectionId: d }, d) : null
    )
  ] });
}
const Le = "templates.cart.sections.cart_main";
function uo(e) {
  const t = e.productVariantId;
  return typeof t == "object" && t !== null && "_id" in t ? t : null;
}
function ar() {
  const e = j(), t = rt(), { text: i, background: n, primary: s, fontHeading: u, fontBody: d } = B(), { user: a, checkAuth: r } = Ze(), { getAllItems: p, getCartByCustomerId: c, updateCartEntry: h, deleteCartEntry: g, loading: $ } = xt(), [b, v] = Z({}), x = l(e, `${Le}.settings.title`), z = l(e, `${Le}.blocks.empty_state.blocks.empty_message.settings.emptyTitle`), S = l(e, `${Le}.blocks.empty_state.blocks.continue_link.settings.label`), _ = l(e, `${Le}.blocks.empty_state.blocks.continue_link.settings.href`), H = l(e, `${Le}.blocks.line_items.blocks.item_actions.settings.removeLabel`), w = l(e, `${Le}.blocks.line_items.blocks.item_actions.settings.loadingLabel`), L = l(e, `${Le}.blocks.cart_summary.blocks.subtotal.settings.label`);
  ue(() => {
    t || r();
  }, [r, t]), ue(() => {
    t || !a?._id || c(a._id);
  ...
  const T = p(), W = F(() => T.length > 0 ? T : t ? Ai : [], [T, t]), P = F(() => {
    ...
    for (const G of W) {
      const N = uo(G);
      N && (f += N.price * G.quantity);
    }
    return f;
  }, [W]), C = !t && $ && W.length === 0, M = !C && W.length === 0;
  return /* @__PURE__ */ o(Ae, { children: /* @__PURE__ */ o(O, { sectionId: "cart_main", label: "Cart", style: { padding: `40px ${R.padX}px 64px`, fontFamily: d, color: i }, children: /* @__PURE__ */ m("div", { style: { maxWidth: 880, margin: "0 auto" }, children: [
    /* @__PURE__ */ o(k, { fieldPath: `${Le}.settings.title`, label: "Page title", as: "h1", style: { fontFamily: u, fontSize: 32, marginTop: 0 }, children: x }),
    ...
    M ? /* @__PURE__ */ o(E, { nodeId: "template:cart:cart_main:block:empty_state", label: "Empty cart", children: /* @__PURE__ */ m("p", { style: { opacity: 0.7 }, children: [
      /* @__PURE__ */ o(k, { fieldPath: `${Le}.blocks.empty_state.blocks.empty_message.settings.emptyTitle`, label: "Empty cart text", as: "span", children: z }),
      " ",
      /* @__PURE__ */ o(I, { to: _, style: { color: s }, children: /* @__PURE__ */ o(k, { fieldPath: `${Le}.blocks.empty_state.blocks.continue_link.settings.label`, label: "Link label", as: "span", children: S }) })
    ] }) }) : null,
    W.length > 0 ? /* @__PURE__ */ m(ae, { children: [
      /* @__PURE__ */ o(E, { nodeId: "template:cart:cart_main:block:line_items", label: "Line items", children: /* @__PURE__ */ o("div", { style: { display: "grid", gap: 12, marginTop: 24 }, children: W.map((f) => {
        const G = uo(f);
        return /* @__PURE__ */ o("article", { style: { border: `1px solid ${R.line}`, borderRadius: 10, padding: 16, background: n }, children: /* @__PURE__ */ m("div", { style: { display: "flex", justifyContent: "space-between", gap: 16, flexWrap: "wrap" }, children: [
          /* @__PURE__ */ m("div", { children: [
            G ? /* @__PURE__ */ o(I, { to: `/products/${G.productId}`, style: { color: i, fontWeight: 600 }, onClick: (N) => t && N.preventDefault(), children: G.sku }) : /* @__PURE__ */ o("span", { children: "Item" }),
          ...
          /* @__PURE__ */ m("div", { style: { display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 8 }, children: [
            ...
            /* @__PURE__ */ o(E, { nodeId: "template:cart:cart_main:block:line_items:block:item_actions", label: "Item actions", children: /* @__PURE__ */ o(
              "button",
              {
                ...
                children: /* @__PURE__ */ o(k, { fieldPath: `${Le}.blocks.line_items.blocks.item_actions.settings.removeLabel`, label: "Remove button", as: "span", children: H })
              }
            ) })
          ] })
        ] }) }, f._id);
      ...
      /* @__PURE__ */ o(E, { nodeId: "template:cart:cart_main:block:cart_summary", label: "Summary", children: /* @__PURE__ */ m("p", { style: { marginTop: 24, fontSize: 20, fontWeight: 600 }, children: [
        /* @__PURE__ */ o(k, { fieldPath: `${Le}.blocks.cart_summary.blocks.subtotal.settings.label`, label: "Subtotal prefix", as: "span", children: L }),
        " ",
        Ye(P)
      ] }) })
    ] }) : null
...
function zt(e, t, i, n, s) {
  const d = `${n === "template" ? `templates.${t}.sections.${i}` : `sections.${i}`}.blocks`, a = n === "template" ? Re(e, t, i, []) : Pe(e, i, []), r = V(e, d);
...
function hr({
  ...
  const n = j(), { fontBody: s } = B(), u = ot(null), d = i === "template" ? `templates.${t}.sections.${e}.settings` : `sections.${e}.settings`, a = i === "template" ? `template:${t}:${e}` : `layout:${e}`, r = F(
    () => cr(n, d),
    [n, d]
  ), p = F(
    () => zt(n, t, e, i, r.postCount),
    [n, t, e, i, r.postCount]
  ), c = r.sectionWidth === "full" ? 24 : R.padX, h = r.sectionWidth === "full" ? "100%" : R.maxWidth, g = `ziplofy-blog-posts-${e.replace(/[^a-z0-9_-]/gi, "-")}`, $ = r.columns > 0 ? `calc((100% - ${(r.columns - 1) * r.horizontalGap}px) / ${r.columns})` : "280px", b = (C) => {
    const M = u.current;
    if (!M) return;
  ...
  return /* @__PURE__ */ o(O, { nodeId: a, label: "Blog posts: Carousel", children: /* @__PURE__ */ m(
    "section",
    {
      className: g,
      style: v,
...
function gr({
  ...
  const n = j(), { fontBody: s } = B(), u = i === "template" ? `templates.${t}.sections.${e}.settings` : `sections.${e}.settings`, d = i === "template" ? `template:${t}:${e}` : `layout:${e}`, a = F(
    ...
    [n, t, e, i, a.postCount]
  ), p = a.sectionWidth === "full" ? 24 : R.padX, c = a.sectionWidth === "full" ? "100%" : R.maxWidth, h = `ziplofy-blog-posts-editorial-${e.replace(/[^a-z0-9_-]/gi, "-")}`, g = a.layoutGap, $ = r.length >= 2 ? r.slice(0, 2) : r.length === 1 ? [] : [], b = r.length >= 3 ? r[2] : r.length === 1 ? r[0] : null, v = r.length > 3 ? r.slice(3) : [], x = {
    position: "relative",
    background: a.scheme.background,
    color: a.scheme.color,
    paddingTop: a.paddingTop,
    ...
    scrollSnapAlign: "start"
  }, T = (P) => i === "template" ? `templates.${t}.sections.${e}.blocks.${P}.settings` : `sections.${e}.blocks.${P}.settings`, W = /* @__PURE__ */ m(ae, { children: [
  ...
  return /* @__PURE__ */ o(O, { nodeId: d, label: "Blog posts: Editorial", children: /* @__PURE__ */ m(
    "section",
    {
      className: h,
      style: x,
      ...
      children: [
        ...
        /* @__PURE__ */ m("div", { style: z, children: [
          ...
          /* @__PURE__ */ o("div", { "data-mobile-layout": !0, style: { display: "none" }, children: /* @__PURE__ */ o("div", { "data-mobile-track": !0, style: w, children: r.map((P) => /* @__PURE__ */ o("div", { style: L, children: /* @__PURE__ */ o(
            st,
            {
              card: P,
              editorNodeId: d,
...
function fo({ card: e, editorNodeId: t, blockBase: i, scheme: n, fontBody: s }) {
...
function yr({
  ...
  const n = j(), { fontBody: s } = B(), u = i === "template" ? `templates.${t}.sections.${e}.settings` : `sections.${e}.settings`, d = i === "template" ? `template:${t}:${e}` : `layout:${e}`, a = F(() => fr(n, u), [n, u]), r = F(
    () => zt(n, t, e, i, a.postCount),
    [n, t, e, i, a.postCount]
  ), p = a.sectionWidth === "full" ? 24 : R.padX, c = a.sectionWidth === "full" ? "100%" : R.maxWidth, h = `ziplofy-blog-posts-grid-${e.replace(/[^a-z0-9_-]/gi, "-")}`, g = Math.max(1, Math.min(4, a.columns)), $ = {
    position: "relative",
    background: a.scheme.background,
    color: a.scheme.color,
    paddingTop: a.paddingTop,
  ...
  return /* @__PURE__ */ o(O, { nodeId: d, label: "Blog posts: Grid", children: /* @__PURE__ */ m(
    "section",
    {
      className: h,
      style: $,
...
function Sr({
  ...
  const n = j(), { fontBody: s } = B(), u = ot(null), d = i === "template" ? `templates.${t}.sections.${e}.settings` : `sections.${e}.settings`, a = i === "template" ? `template:${t}:${e}` : `layout:${e}`, r = F(
    ...
    () => kr(n, t, e, i),
    [n, t, e, i]
  ), c = r.sectionWidth === "full" ? 24 : R.padX, h = r.sectionWidth === "full" ? "100%" : R.maxWidth, g = `ziplofy-storytelling-carousel-${e.replace(/[^a-z0-9_-]/gi, "-")}`, $ = Math.max(1, Math.min(4, r.columns)), b = `calc((100% - ${($ - 1) * r.horizontalGap}px) / ${$})`, v = (w) => {
    const L = u.current;
    L && L.scrollBy({ left: L.clientWidth * 0.85 * w, behavior: "smooth" });
  ...
  return /* @__PURE__ */ o(O, { nodeId: a, label: "Carousel", children: /* @__PURE__ */ m(
    "section",
    {
      className: g,
      style: z,
        ...
        /* @__PURE__ */ m("div", { style: S, children: [
          ...
          /* @__PURE__ */ m("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [
            ...
            /* @__PURE__ */ o("div", { ref: u, "data-carousel-track": !0, style: _, children: p.map((w) => {
              const L = i === "template" ? `templates.${t}.sections.${e}.blocks.${w.id}.settings` : `sections.${e}.blocks.${w.id}.settings`;
...
function wr(e, t) {
  ...
  return {
    scheme: xo[i] ?? xo["scheme-1"],
    heading: l(e, `${t}.heading`),
    imageUrl: l(e, `${t}.imageUrl`, ""),
    mediaOverlay: !!V(e, `${t}.mediaOverlay`),
    sectionWidth: n === "full" ? "full" : "page",
...
function Pr({
  ...
  const n = j(), { fontBody: s, fontHeading: u } = B(), [d, a] = Z(null), r = i === "template" ? `templates.${t}.sections.${e}.settings` : `sections.${e}.settings`, p = i === "template" ? `template:${t}:${e}` : `layout:${e}`, c = F(
    () => wr(n, r),
    [n, r]
  ), h = F(
    () => Cr(n, t, e, i),
    ...
    fontFamily: s
  }, x = c.sectionWidth === "full" ? { maxWidth: "100%", paddingLeft: 0, paddingRight: 0 } : { maxWidth: R.contentMaxWidth, margin: "0 auto", paddingLeft: 24, paddingRight: 24 }, z = {
    position: "relative",
    width: "100%",
  ...
  return /* @__PURE__ */ m(O, { sectionId: e, label: "Product hotspots", editorNodeId: p, style: v, children: [
    ...
    /* @__PURE__ */ m("div", { className: g, style: x, children: [
      ...
      /* @__PURE__ */ m("div", { style: z, children: [
        ...
        h.map((_) => {
          const H = i === "template" ? `template:${t}:${e}:block:${_.id}` : `layout:${e}:block:${_.id}`, w = d === _.id, L = {
            position: "relative",
            width: 20,
            height: 20,
            borderRadius: "50%",
...
function Hr(e, t) {
  ...
  return {
    ...
    carouselOnMobile: !!V(e, `${t}.carouselOnMobile`),
...
function Mr({
  ...
  const n = j(), { fontBody: s, fontHeading: u } = B(), d = ot(null), a = i === "template" ? `templates.${t}.sections.${e}.settings` : `sections.${e}.settings`, r = i === "template" ? `template:${t}:${e}` : `layout:${e}`, p = F(
    () => Hr(n, a),
    [n, a]
  ), c = F(
    () => Lr(
  ...
  ), h = p.cardStyle === "carousel", g = `ziplofy-recommended-products-${e.replace(/[^a-z0-9_-]/gi, "-")}`, $ = Rr(e, p.customCss), b = F(
    () => `
              ...
              /* @__PURE__ */ m("div", { style: { position: "relative" }, children: [
                h ? /* @__PURE__ */ m(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ o(ko, { label: "Previous", onClick: () => S(-1), background: "circle", shape: "arrows" }),
                      /* @__PURE__ */ o(ko, { label: "Next", onClick: () => S(1), background: "circle", shape: "arrows" })
                    ]
                  }
                ) : null,
...
function So({
  ...
  const n = j(), { fontBody: s } = B(), u = i === "template" ? `templates.${t}.sections.${e}.settings` : `sections.${e}.settings`, d = i === "template" ? `template:${t}:${e}` : `layout:${e}`, a = F(
    ...
    "div",
    {
      ...
      children: c.map((w) => {
        const L = i === "template" ? `templates.${t}.sections.${e}.blocks.${w.id}.settings` : `sections.${e}.blocks.${w.id}.settings`, T = i === "template" ? `template:${t}:${e}:block:${w.id}` : `layout:${e}:block:${w.id}`;
        return /* @__PURE__ */ o(E, { nodeId: T, label: "Collection link", children: /* @__PURE__ */ m(I, { to: w.href, style: z, children: [
          /* @__PURE__ */ o(k, { fieldPath: `${L}.title`, label: "Title", children: w.title }),
          /* @__PURE__ */ o(
            "sup",
            {
              style: {
              ...
              children: /* @__PURE__ */ o(k, { fieldPath: `${L}.productCount`, label: "Product count", children: w.productCount })
            }
          )
        ] }) }, w.id);
      })
...
function Vr({
  ...
  const n = j(), { fontBody: s, fontHeading: u } = B(), d = i === "template" ? `templates.${t}.sections.${e}.settings` : `sections.${e}.settings`, a = i === "template" ? `template:${t}:${e}` : `layout:${e}`, r = F(
    () => Xr(n, d),
    [n, d]
  ), p = F(
    () => mt(n, t, e, i),
...
function Zr({
  ...
  const n = j(), { fontBody: s, fontHeading: u } = B(), d = ot(null), a = i === "template" ? `templates.${t}.sections.${e}.settings` : `sections.${e}.settings`, r = i === "template" ? `template:${t}:${e}` : `layout:${e}`, p = F(
    ...
    () => mt(n, t, e, i),
    [n, t, e, i]
  ), h = `ziplofy-collection-list-carousel-${e.replace(/[^a-z0-9_-]/gi, "-")}`, g = (p.sectionWidth === "full", 24), $ = p.sectionWidth === "full" ? "100%" : R.contentMaxWidth, b = p.columns > 0 ? `calc((100% - ${(p.columns - 1) * p.horizontalGap}px) / ${p.columns})` : "200px", v = (W) => {
    const P = d.current;
  ...
  return /* @__PURE__ */ o(O, { sectionId: e, label: "Collection list: Carousel", editorNodeId: r, style: z, children: /* @__PURE__ */ m("div", { className: h, style: S, "data-mobile-columns": p.mobileColumns, children: [
    /* @__PURE__ */ o("style", { children: `
...
function ca({
  ...
  const n = j(), { fontBody: s, fontHeading: u } = B(), [d, a] = Z(0), r = i === "template" ? `templates.${t}.sections.${e}.settings` : `sections.${e}.settings`, p = i === "template" ? `template:${t}:${e}` : `layout:${e}`, c = F(
    () => ra(n, r),
    [n, r]
  ), h = F(
    () => Wt(n, t, e, i),
  ...
  return b ? /* @__PURE__ */ m(O, { nodeId: p, label: "Layered slideshow", children: [
    ...
    /* @__PURE__ */ o("section", { "data-ziplofy-section": e, className: x, style: _, children: /* @__PURE__ */ o("div", { style: H, children: /* @__PURE__ */ m("div", { style: w, children: [
      ...
      /* @__PURE__ */ o(
        "div",
        {
          ...
          "aria-hidden": !0,
          children: /* @__PURE__ */ o(pi, { variant: v.peekVariant })
        }
      ),
      g > 1 ? /* @__PURE__ */ o(
        "div",
...
function ma({
  ...
  ue(() => {
    ...
    const D = window.setInterval(() => a((K) => (K + 1) % g), 5e3);
    return () => window.clearInterval(D);
  }, [c.autoRotate, g]);
  const S = `ziplofy-slideshow-full-frame-${e.replace(/[^a-z0-9_-]/gi, "-")}`, _ = pa(e, c.customCss), H = ua(c.mediaHeight), w = c.contentPosition === "on-media", L = c.navigationIcon !== "none" && g > 1, T = c.navigationIcon === "chevron" ? "chevron" : "arrows", W = c.navigationIcon === "large-arrows" ? "large-arrows" : c.navigationIcon, P = {
    paddingTop: c.paddingTop,
    paddingBottom: c.paddingBottom,
    ...
    background: c.scheme.background
  }, f = w ? "#fff" : c.scheme.color, G = w ? "rgba(255,255,255,0.92)" : c.scheme.muted;
  if (!b) return null;
  const N = r.replace(".settings", "");
  return /* @__PURE__ */ m(O, { nodeId: p, label: "Slideshow: Full frame", children: [
    ...
    /* @__PURE__ */ o("section", { "data-ziplofy-section": e, className: S, style: P, children: /* @__PURE__ */ m("div", { style: C, children: [
      /* @__PURE__ */ m("div", { style: M, children: [
        /* @__PURE__ */ o(mi, { imageUrl: b.imageUrl || void 0 }),
        w ? /* @__PURE__ */ o(
          "div",
          {
            style: {
            ...
            children: h.map((D, K) => /* @__PURE__ */ o(
              "button",
              {
                ...
                style: {
                  ...
                  borderRadius: "50%",
                  cursor: "pointer",
                  background: K === $ ? "#fff" : "rgba(255,255,255,0.45)"
                }
              },
              D.id
            ))
...
function ga(e, t) {
  ...
  return {
    ...
    fullWidthOnMobile: !!V(e, `${t}.fullWidthOnMobile`),
    mediaHeight: n === "small" || n === "large" ? n : "medium",
...
function xa({
  ...
  const n = j(), { fontBody: s, fontHeading: u } = B(), [d, a] = Z(0), r = i === "template" ? `templates.${t}.sections.${e}.settings` : `sections.${e}.settings`, p = i === "template" ? `template:${t}:${e}` : `layout:${e}`, c = F(
    ...
    () => ba(n, t, e, i),
    [n, t, e, i]
  ), g = Math.max(1, h.length), $ = (d % g + g) % g, b = h[$] ?? h[0], v = h[($ + 1) % g] ?? b, x = qe(() => a((X) => (X - 1 + g) % g), [g]), z = qe(() => a((X) => (X + 1) % g), [g]), S = qe((X) => a(X), []), _ = `ziplofy-slideshow-inset-${e.replace(/[^a-z0-9_-]/gi, "-")}`, H = ya(e, c.customCss), w = fa(c.mediaHeight), L = c.contentPosition === "below-media", T = c.navigationIcon !== "none" && g > 1, W = c.navigationIcon === "chevron" ? "chevron" : "arrows", P = c.navigationIcon === "large-arrows" ? "large-arrows" : c.navigationIcon === "chevron" ? "chevron" : "arrows", C = {
    paddingTop: c.paddingTop,
    paddingBottom: c.paddingBottom,
    background: c.scheme.background,
    color: c.scheme.color,
  ...
  if (!b) return null;
  const K = r.replace(".settings", ""), te = /* @__PURE__ */ m(E, { nodeId: `${p}:${b.id}`, label: "Slide", children: [
    /* @__PURE__ */ o(k, { fieldPath: `${K}.blocks.${b.id}.settings.title`, label: "Heading", children: /* @__PURE__ */ o(
      "h2",
      {
        style: {
          margin: 0,
          ...
          lineHeight: 1.15,
          letterSpacing: "-0.02em",
          color: L ? c.scheme.color : "#fff",
          textAlign: "center"
        },
        children: b.title
      }
    ) }),
    /* @__PURE__ */ o(k, { fieldPath: `${K}.blocks.${b.id}.settings.body`, label: "Text", children: /* @__PURE__ */ o(
      "p",
      {
        style: {
          margin: "12px auto 0",
          ...
          fontSize: "1rem",
          lineHeight: 1.55,
          color: L ? c.scheme.muted : "rgba(255,255,255,0.92)",
          textAlign: "center"
        },
        children: b.body
      }
    ) }),
    /* @__PURE__ */ o(k, { fieldPath: `${K}.blocks.${b.id}.settings.buttonLabel`, label: "Button label", children: /* @__PURE__ */ o(
      I,
      {
        to: b.buttonHref || "#",
        style: {
  ...
  return /* @__PURE__ */ m(O, { nodeId: p, label: "Slideshow: Inset", children: [
    H ? /* @__PURE__ */ o("style", { children: H }) : null,
    /* @__PURE__ */ o("section", { "data-ziplofy-section": e, className: _, style: C, children: /* @__PURE__ */ o("div", { style: M, children: /* @__PURE__ */ m("div", { style: f, children: [
      /* @__PURE__ */ m("div", { style: G, children: [
        /* @__PURE__ */ m("div", { style: N, children: [
          ...
          c.pagination === "dots" && g > 1 && !L ? /* @__PURE__ */ o(
            "div",
            {
              style: {
                position: "absolute",
              ...
              children: h.map((X, de) => /* @__PURE__ */ o(
                "button",
                {
                  type: "button",
        ...
        g > 1 ? /* @__PURE__ */ o("div", { style: D, "aria-hidden": !0, children: /* @__PURE__ */ o(pi, { variant: v.peekVariant }) }) : null
      ] }),
      L ? /* @__PURE__ */ o("div", { style: { textAlign: "center", padding: "0 24px 8px" }, children: te }) : null,
      c.pagination === "dots" && g > 1 && L ? /* @__PURE__ */ o("div", { style: { display: "flex", justifyContent: "center", gap: 8, paddingBottom: 8 }, children: h.map((X, de) => /* @__PURE__ */ o(
        "button",
        {
          type: "button",
          "aria-label": `Go to slide ${de + 1}`,
...
function _a(e, t, i, n) {
  const s = l(e, `${t}.titleTypographyPreset`, "heading-4"), u = Mo[s] ?? Mo["heading-4"], d = l(e, `${t}.titleWidth`, "fit"), a = l(e, `${t}.titleMaxWidth`), r = l(e, `${t}.titleColor`, "text"), p = r === "heading" ? n.heading : r === "accent" ? n.accent : n.text, c = U(e, `${t}.titleBackgroundEnabled`, !1);
  return {
    width: d === "fill" ? "100%" : "fit-content",
    maxWidth: Fo[a] ?? Fo.normal,
...
function Wa(e, t, i, n) {
  const s = l(e, `${t}.priceTypographyPreset`), u = Ao[s] ?? Ao["heading-6"], d = l(e, `${t}.priceWidth`, "fill"), a = l(e, `${t}.priceAlignment`, "left"), r = l(e, `${t}.priceColor`, "text"), p = r === "heading" ? n.heading : r === "accent" ? n.accent : r === "muted" ? n.muted : n.text;
  return {
    width: d === "fill" ? "100%" : "fit-content",
...
function Ta(e, t, i, n) {
  const s = l(e, `${t}.productTitleTypographyPreset`, "default"), u = Uo[s] ?? Uo.default, d = l(e, `${t}.productTitleWidth`, "fill"), a = l(e, `${t}.productTitleMaxWidth`), r = l(e, `${t}.productTitleAlignment`, "left"), p = U(e, `${t}.productTitleBackgroundEnabled`, !1), c = r === "center" ? "center" : r === "right" ? "right" : "left";
  return {
    width: d === "fill" ? "100%" : "fit-content",
    maxWidth: No[a] ?? No.normal,
    textAlign: c,
    fontFamily: i,
    fontSize: u.fontSize,
    fontWeight: u.fontWeight,
...
`,
  ...
  ue(() => {
    x?.storeId && S({ storeId: x.storeId, page: 1, limit: G });
  }, [S, G, x?.storeId]);
  const J = z.slice(0, G), Q = ke && Ue !== "none" && J.length > M, q = W === "full" ? "100%" : R.maxWidth, ee = lt(
    n,
        ...
        "div",
        {
          ...
          children: [
            ee.map((ie) => ie === "collection_title" ? /* @__PURE__ */ o(
              ...
              ie
            ) : ie === "view_all_button" && X.trim() ? /* @__PURE__ */ o(
              E,
              {
            ...
            K ? /* @__PURE__ */ o("p", { style: { margin: 0, fontSize: 14, color: H.muted, maxWidth: 480 }, children: K }) : null
          ]
        }
      )
    }
    ...
    const pe = ie.imageUrls?.[0], nt = ce ? /* @__PURE__ */ o(E, { nodeId: `${p}:block:product_card:nested:media`, label: "Media", children: /* @__PURE__ */ o(
      ...
      "h3",
      {
        style: {
          ...
          textAlign: le.textAlign,
          fontFamily: le.fontFamily,
          fontSize: Math.max(12, Math.round(le.fontSize * Te)),
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ o(
            "p",
            {
              style: {
                ...
                fontSize: Math.max(11, Math.round(re.fontSize * Te)),
          ...
          re.showInstallments ? /* @__PURE__ */ o("p", { style: { margin: "4px 0 0", fontSize: 12, color: H.muted }, children: "Pay in installments" }) : null,
          re.showTaxInfo ? /* @__PURE__ */ o("p", { style: { margin: "2px 0 0", fontSize: 11, color: H.muted }, children: "Tax included" }) : null
        ]
      }
    ) }) : null;
    return /* @__PURE__ */ o(
...
const Aa = {
  ...
  email_signup: Vo,
  custom_section: dr,
  product_highlight: Qo,
  editorial: Jo,
  editorial_jumbo: ei,
  image_compare: ti,
  image_with_text: oi,
  storytelling_logo: ci,
  storytelling_video: si,
  faq_section: ii,
  icons_with_text: ni,
  multicolumn_section: li,
  pull_quote_section: ri,
  rich_text_section: ai,
  text_marquee_section: di,
  ...
  collection_links_spotlight: So,
  collection_links_text: So,
...
function Oa() {
  const e = j(), { login: t, loading: i } = Ze(), { storeFrontMeta: n } = it(), s = $t(), { text: u, primary: d, fontHeading: a, fontBody: r } = B(), [p, c] = Z(""), [h, g] = Z(""), $ = l(e, `${me}.settings.eyebrow`, ""), b = l(e, `${me}.settings.title`), v = l(e, `${me}.settings.subtitle`, ""), x = l(e, `${me}.blocks.form_fields.blocks.email_field.settings.placeholder`), z = l(e, `${me}.blocks.form_fields.blocks.password_field.settings.placeholder`), S = l(e, `${me}.blocks.primary_button.settings.label`), _ = l(e, `${me}.blocks.primary_button.settings.loadingLabel`), H = l(e, `${me}.blocks.footer_link.blocks.signup_prompt.settings.text`), w = l(e, `${me}.blocks.footer_link.blocks.signup_link.settings.label`), L = l(e, `${me}.blocks.footer_link.blocks.signup_link.settings.href`), T = l(e, `${me}.blocks.forgot_password_link.settings.label`), W = l(e, `${me}.blocks.forgot_password_link.settings.href`), P = async (C) => {
  ...
  return /* @__PURE__ */ o(Ae, { children: /* @__PURE__ */ o(
    O,
    {
      ...
      label: "Login form",
      style: { padding: `48px ${R.padX}px 80px`, fontFamily: r, color: u },
      children: /* @__PURE__ */ m("div", { style: { maxWidth: 440, margin: "0 auto", border: `1px solid ${R.line}`, borderRadius: 12, padding: 40 }, children: [
        ...
        /* @__PURE__ */ o(E, { nodeId: "template:login:login_main:block:footer_link", label: "Sign up link", children: /* @__PURE__ */ m("p", { style: { marginTop: 20, fontSize: 14 }, children: [
          ...
          /* @__PURE__ */ o(I, { to: L, style: { color: d, fontWeight: 600 }, children: /* @__PURE__ */ o(k, { fieldPath: `${me}.blocks.footer_link.blocks.signup_link.settings.label`, label: "Link label", as: "span", children: w }) })
        ] }) })
      ] })
    }
  ) });
...
function Ga() {
  const e = j(), t = rt(), { user: i, checkAuth: n } = Ze(), { orders: s, getOrdersByCustomerId: u, loading: d } = bi(), { text: a, fontHeading: r, fontBody: p } = B(), c = l(e, `${we}.settings.title`), h = l(e, `${we}.settings.subtitle`, ""), g = l(e, `${we}.blocks.loading_state.settings.message`), $ = l(e, `${we}.blocks.empty_state.settings.message`), b = l(e, `${we}.blocks.order_card.blocks.order_total_line.settings.label`), v = l(e, `${we}.blocks.order_card.blocks.order_date_line.settings.prefix`), x = l(e, `${we}.blocks.order_card.blocks.status_line.settings.prefix`);
  ue(() => {
    t || n();
  }, [n, t]), ue(() => {
    t || !i?._id || u(i._id);
  ...
  return /* @__PURE__ */ o(Ae, { children: /* @__PURE__ */ m(
    O,
    {
      ...
      label: "Order history",
      style: { padding: `48px ${R.padX}px 80px`, maxWidth: 720, margin: "0 auto", fontFamily: p, color: a },
      children: [
        ...
        /* @__PURE__ */ o("div", { style: { display: "grid", gap: 16, marginTop: 24 }, children: z.map((H) => /* @__PURE__ */ o(E, { nodeId: "template:orders:orders_main:block:order_card", label: "Order card", children: /* @__PURE__ */ m("article", { style: { border: `1px solid ${R.line}`, borderRadius: 10, padding: 20 }, children: [
...
function ja() {
  const e = j(), t = rt(), { user: i, checkAuth: n, updateUser: s, loading: u } = Ze(), { text: d, primary: a, fontHeading: r, fontBody: p } = B(), [c, h] = Z("en"), [g, $] = Z(!1), [b, v] = Z(!1), x = i ?? (t ? Xe : null), z = l(e, `${_e}.settings.title`), S = l(e, `${_e}.settings.subtitle`, ""), _ = l(e, `${_e}.blocks.signed_out.settings.message`), H = l(e, `${_e}.blocks.marketing_options.blocks.email_marketing.settings.label`), w = l(e, `${_e}.blocks.marketing_options.blocks.sms_marketing.settings.label`), L = l(e, `${_e}.blocks.marketing_options.blocks.language_field.settings.label`), T = l(e, `${_e}.blocks.save_button.settings.label`), W = l(e, `${_e}.blocks.save_button.settings.savingLabel`);
  ue(() => {
    t || n();
  }, [n, t]), ue(() => {
  ...
  return x ? /* @__PURE__ */ o(Ae, { children: /* @__PURE__ */ o(O, { sectionId: "preferences_main", label: "Preferences", style: { padding: `48px ${R.padX}px 80px`, fontFamily: p, color: d }, children: /* @__PURE__ */ m("div", { style: { maxWidth: 520, margin: "0 auto", border: `1px solid ${R.line}`, borderRadius: 12, padding: 40 }, children: [
    ...
    /* @__PURE__ */ m("form", { onSubmit: (C) => {
      ...
      /* @__PURE__ */ m(E, { nodeId: "template:preferences:preferences_main:block:marketing_options", label: "Marketing", children: [
        /* @__PURE__ */ m("label", { style: { display: "grid", gap: 8 }, children: [
          /* @__PURE__ */ o(k, { fieldPath: `${_e}.blocks.marketing_options.blocks.language_field.settings.label`, label: "Field label", as: "span", children: L }),
          /* @__PURE__ */ m(
            "select",
            {
              value: c,
...
function Da() {
  ...
  return /* @__PURE__ */ o(Ae, { children: /* @__PURE__ */ o(O, { sectionId: "product_main", label: "Product details", style: { padding: `48px ${R.padX}px` }, children: /* @__PURE__ */ m(
    "div",
    {
      style: {
        maxWidth: R.maxWidth,
...
function Ba() {
  const e = j(), t = rt(), { user: i, checkAuth: n, updateUser: s, loading: u } = Ze(), d = $t(), { text: a, primary: r, fontHeading: p, fontBody: c } = B(), [h, g] = Z(""), [$, b] = Z(""), [v, x] = Z(""), z = i ?? (t ? Xe : null), S = l(e, `${be}.settings.title`), _ = l(e, `${be}.settings.subtitle`, ""), H = l(e, `${be}.blocks.signed_out.blocks.empty_message.settings.text`), w = l(e, `${be}.blocks.signed_out.blocks.sign_in_button.settings.label`), L = l(e, `${be}.blocks.profile_form.blocks.email_field.settings.label`), T = l(e, `${be}.blocks.profile_form.blocks.email_field.settings.helperText`, ""), W = l(e, `${be}.blocks.profile_form.blocks.first_name_field.settings.placeholder`), P = l(e, `${be}.blocks.profile_form.blocks.last_name_field.settings.placeholder`), C = l(e, `${be}.blocks.profile_form.blocks.phone_field.settings.placeholder`), M = l(e, `${be}.blocks.save_button.settings.label`), f = l(e, `${be}.blocks.save_button.settings.savingLabel`);
  if (ue(() => {
    t || n();
  }, [n, t]), ue(() => {
    z && (g(z.firstName || ""), b(z.lastName || ""), x(z.phoneNumber || ""));
  }, [z]), !z)
    return /* @__PURE__ */ o(Ae, { children: /* @__PURE__ */ o(O, { sectionId: "profile_main", label: "Profile", style: { padding: `48px ${R.padX}px`, textAlign: "center", fontFamily: c, color: a }, children: /* @__PURE__ */ m(E, { nodeId: "template:profile:profile_main:block:signed_out", label: "Signed out", children: [
  ...
  return /* @__PURE__ */ o(Ae, { children: /* @__PURE__ */ o(O, { sectionId: "profile_main", label: "Profile", style: { padding: `48px ${R.padX}px 80px`, fontFamily: c, color: a }, children: /* @__PURE__ */ m("div", { style: { maxWidth: 480, margin: "0 auto", border: `1px solid ${R.line}`, borderRadius: 12, padding: 40 }, children: [
    ...
    /* @__PURE__ */ m("form", { onSubmit: (N) => {
      ...
      /* @__PURE__ */ m(E, { nodeId: "template:profile:profile_main:block:profile_form", label: "Profile form", children: [
        /* @__PURE__ */ m("label", { style: { display: "grid", gap: 6 }, children: [
          /* @__PURE__ */ o(k, { fieldPath: `${be}.blocks.profile_form.blocks.email_field.settings.label`, label: "Email label", as: "span", style: { fontSize: 13, fontWeight: 600 }, children: L }),
...
function Xa() {
  const e = j(), { text: t, primary: i, fontHeading: n, fontBody: s } = B(), [u, d] = Z(""), [a, r] = Z(!1), p = l(e, `${ze}.settings.eyebrow`, ""), c = l(e, `${ze}.settings.title`), h = l(e, `${ze}.settings.subtitle`, ""), g = l(e, `${ze}.blocks.form_fields.blocks.email_field.settings.placeholder`), $ = l(e, `${ze}.blocks.primary_button.settings.label`), b = l(e, `${ze}.blocks.success_message.settings.text`), v = l(e, `${ze}.blocks.footer_link.blocks.back_link.settings.label`), x = l(e, `${ze}.blocks.footer_link.blocks.back_link.settings.href`), z = (S) => {
    S.preventDefault(), u.trim() && r(!0);
  };
  return /* @__PURE__ */ o(Ae, { children: /* @__PURE__ */ o(O, { sectionId: "forgot_main", label: "Reset password", style: { padding: `48px ${R.padX}px 80px`, fontFamily: s, color: t }, children: /* @__PURE__ */ m("div", { style: { maxWidth: 440, margin: "0 auto", border: `1px solid ${R.line}`, borderRadius: 12, padding: 40 }, children: [
...
function qa() {
  const e = j(), { signup: t, loading: i } = Ze(), { storeFrontMeta: n } = it(), s = $t(), { text: u, primary: d, fontHeading: a, fontBody: r } = B(), [p, c] = Z(""), [h, g] = Z(""), [$, b] = Z(""), [v, x] = Z(""), z = l(e, `${fe}.settings.eyebrow`, ""), S = l(e, `${fe}.settings.title`), _ = l(e, `${fe}.settings.subtitle`, ""), H = l(e, `${fe}.blocks.form_fields.blocks.first_name_field.settings.placeholder`), w = l(e, `${fe}.blocks.form_fields.blocks.last_name_field.settings.placeholder`), L = l(e, `${fe}.blocks.form_fields.blocks.email_field.settings.placeholder`), T = l(e, `${fe}.blocks.form_fields.blocks.password_field.settings.placeholder`), W = l(e, `${fe}.blocks.primary_button.settings.label`), P = l(e, `${fe}.blocks.primary_button.settings.loadingLabel`), C = l(e, `${fe}.blocks.footer_link.blocks.login_prompt.settings.text`), M = l(e, `${fe}.blocks.footer_link.blocks.login_link.settings.label`), f = l(e, `${fe}.blocks.footer_link.blocks.login_link.settings.href`), G = async (N) => {
    N.preventDefault(), n?.storeId && (await t({ storeId: n.storeId, firstName: p, lastName: h, email: $, password: v }), s("/"));
  };
  return /* @__PURE__ */ o(Ae, { children: /* @__PURE__ */ o(O, { sectionId: "signup_main", label: "Sign up form", style: { padding: `48px ${R.padX}px 80px`, fontFamily: r, color: u }, children: /* @__PURE__ */ m("div", { style: { maxWidth: 440, margin: "0 auto", border: `1px solid ${R.line}`, borderRadius: 12, padding: 40 }, children: [
    ...
    /* @__PURE__ */ m("form", { onSubmit: (N) => {
      ...
      /* @__PURE__ */ m(E, { nodeId: "template:signup:signup_main:block:form_fields", label: "Form fields", children: [
        ...
        /* @__PURE__ */ o("input", { value: $, onChange: (N) => b(N.target.value), placeholder: L, style: We }),
