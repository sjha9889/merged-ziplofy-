import{r as a,j as e,b as oe,aZ as ae,u as B,t as se,n as G,aK as ie,aB as re,k as le,N as ce,aA as de,y as ue,aL as me,aJ as pe,a_ as he,ao as ge,M as O,a$ as fe}from"./index-D8FgqvFC.js";import{r as xe}from"./index-lOdfN9K7.js";import{D as be}from"./DashboardContent-DdXg-7bd.js";import{F as Y}from"./ChevronRightIcon-BcVc913f.js";import{M as ye,u as q,P as ve,a as we,b as ke,L as Ce,m as w}from"./proxy-CdqnbWqb.js";import{F as Z}from"./CheckIcon-CYMN4I-7.js";import{F as je}from"./ArrowRightIcon-qQ8zlmDc.js";import"./CurrencyDollarIcon-7DTC1Le8.js";class Ne extends a.Component{getSnapshotBeforeUpdate(o){const s=this.props.childRef.current;if(s&&o.isPresent&&!this.props.isPresent){const n=this.props.sizeRef.current;n.height=s.offsetHeight||0,n.width=s.offsetWidth||0,n.top=s.offsetTop,n.left=s.offsetLeft}return null}componentDidUpdate(){}render(){return this.props.children}}function Se({children:t,isPresent:o}){const s=a.useId(),n=a.useRef(null),u=a.useRef({width:0,height:0,top:0,left:0}),{nonce:m}=a.useContext(ye);return a.useInsertionEffect(()=>{const{width:b,height:d,top:g,left:i}=u.current;if(o||!n.current||!b||!d)return;n.current.dataset.motionPopId=s;const h=document.createElement("style");return m&&(h.nonce=m),document.head.appendChild(h),h.sheet&&h.sheet.insertRule(`
