import{r as a,j as e,b as oe,aU as ae,u as B,t as se,k as G,_ as ie,aV as re,o as le,aa as ce,aC as de,y as ue,aI as me,aJ as pe,aW as he,aq as ge,Y as O,aX as fe}from"./index-BiuNgHjn.js";import{r as xe}from"./index-D4LnVRSj.js";import{D as be}from"./DashboardContent-B1P7peNJ.js";import{F as Y}from"./ChevronRightIcon-DpA1-52v.js";import{M as ye,u as q,P as ve,a as we,b as ke,L as Ce,m as w}from"./proxy-mJNN36R2.js";import{F as Z}from"./CheckIcon-V2E2sMF0.js";import{F as je}from"./ArrowRightIcon-D4HZLJQt.js";import"./CurrencyDollarIcon-BUoF61ME.js";class Ne extends a.Component{getSnapshotBeforeUpdate(o){const s=this.props.childRef.current;if(s&&o.isPresent&&!this.props.isPresent){const n=this.props.sizeRef.current;n.height=s.offsetHeight||0,n.width=s.offsetWidth||0,n.top=s.offsetTop,n.left=s.offsetLeft}return null}componentDidUpdate(){}render(){return this.props.children}}function Se({children:t,isPresent:o}){const s=a.useId(),n=a.useRef(null),u=a.useRef({width:0,height:0,top:0,left:0}),{nonce:m}=a.useContext(ye);return a.useInsertionEffect(()=>{const{width:b,height:d,top:g,left:i}=u.current;if(o||!n.current||!b||!d)return;n.current.dataset.motionPopId=s;const h=document.createElement("style");return m&&(h.nonce=m),document.head.appendChild(h),h.sheet&&h.sheet.insertRule(`
