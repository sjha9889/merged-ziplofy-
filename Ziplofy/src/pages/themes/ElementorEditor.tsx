...
function addCustomBlocks(editor: grapesjs.Editor) {
  ...
  bm.add('product-grid', {
    label: 'Product Grid',
    category: 'E-commerce',
    content: '<section style="display:grid;grid-template-columns:repeat(3,1fr);gap:24px;padding:40px 24px;"><div style="border:1px solid #e5e7eb;border-radius:8px;overflow:hidden;"><div style="height:200px;background:#f3f4f6;"></div><div style="padding:16px;"><h3 data-gjs-editable="true">Product 1</h3><p data-gjs-editable="true" style="color:#6b7280;">$29.99</p></div></div><div style="border:1px solid #e5e7eb;border-radius:8px;overflow:hidden;"><div style="height:200px;background:#f3f4f6;"></div><div style="padding:16px;"><h3 data-gjs-editable="true">Product 2</h3><p data-gjs-editable="true" style="color:#6b7280;">$39.99</p></div></div><div style="border:1px solid #e5e7eb;border-radius:8px;overflow:hidden;"><div style="height:200px;background:#f3f4f6;"></div><div style="padding:16px;"><h3 data-gjs-editable="true">Product 3</h3><p data-gjs-editable="true" style="color:#6b7280;">$49.99</p></div></div></div></section>',
  });
}
