...
function SectionRow({
  ...
  return (
    ...
    >
      ...
      <span
        className={`flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-[#005bd3] text-white transition-opacity ${
...
function PreviewVisual({
    ...
    return (
      <div className="relative mx-auto w-full max-w-[400px] overflow-hidden rounded-sm border border-white shadow-[0_8px_24px_rgba(0,0,0,0.12)]">
        <div className="flex min-h-[200px]">
          <div className="relative flex w-1/2 flex-col items-center justify-center overflow-hidden bg-[#ebe9e4]">
            <div className="absolute -right-1 top-3 h-10 w-10 rounded-full bg-[#f4a574]/85" aria-hidden />
            <div className="absolute bottom-0 left-0 h-[70%] w-[80%] rounded-tr-[42%] bg-[#3d8b7a]/90" aria-hidden />
            <div className="relative z-10 mb-1 h-[72px] w-[58%]" aria-hidden>
              <div className="absolute left-1/2 top-[5%] h-[22%] w-[38%] -translate-x-1/2 rounded-full bg-[#e8c4a8]" />
              <div className="absolute left-1/2 top-[19%] h-[24%] w-[52%] -translate-x-1/2 rounded-t-md bg-white" />
              <div className="absolute left-1/2 top-[25%] h-[75%] w-[96%] -translate-x-1/2 overflow-hidden rounded-t-[28%] bg-[#4a7fc4]">
                <div className="absolute left-[10%] top-0 h-full w-[14%] bg-[#3a6dad]" />
                <div className="absolute right-[10%] top-0 h-full w-[14%] bg-[#3a6dad]" />
              </div>
            </div>
            <div className="relative z-10 text-center">
              <h3 className="text-[0.82rem] font-bold leading-tight text-white drop-shadow-sm">New arrivals</h3>
              <span className="mt-1 block text-[0.52rem] font-medium text-white underline decoration-white/90">
                Shop now
              </span>
            </div>
          </div>
          <div className="relative flex w-1/2 flex-col overflow-hidden">
            ...
            />
            <div
              className="absolute bottom-[22%] left-0 right-0 h-12 bg-[#2d5a4a]/65"
              style={{
                clipPath:
                  'polygon(0% 100%, 10% 45%, 28% 65%, 48% 35%, 68% 55%, 88% 30%, 100% 50%, 100% 100%)',
              }}
              aria-hidden
            />
            <div className="absolute left-1/2 top-[10%] h-9 w-9 -translate-x-1/2 rounded-full bg-white/95 shadow-sm" aria-hidden />
            <div className="absolute left-[22%] top-[48%] h-8 w-10 rounded-t-full bg-[#3d2914]/75" aria-hidden />
            <div className="absolute right-[22%] top-[46%] h-9 w-9 rounded-t-full bg-[#4a3220]/80" aria-hidden />
            <div className="relative z-10 flex flex-1 items-center justify-center">
              <h3 className="text-[0.82rem] font-bold leading-tight text-white drop-shadow-sm">Bestsellers</h3>
            </div>
            <div className="relative z-10 flex justify-center bg-black/45 py-2">
              <span className="text-[0.52rem] font-medium text-white underline decoration-white/90">
                Shop now
              </span>
            </div>
          </div>
  ...
  if (variant === 'large-logo') {
    return (
      <div className="relative mx-auto w-full max-w-[340px] overflow-hidden rounded-sm border border-white/95 bg-[#f3f0ea] shadow-[0_2px_14px_rgba(0,0,0,0.1)]">
        <div className="relative flex min-h-[200px] items-center justify-center px-6 py-10">
          <p className="absolute left-4 top-4 max-w-[8.25rem] text-left text-[0.52rem] leading-[1.35] text-gray-800">
            Made with care and unconditionally loved by our customers, this signature bestseller exceeds
            all expectations.
          </p>
          <p className="text-[2.65rem] font-bold leading-none tracking-tight text-gray-900">My Store</p>
        </div>
      </div>
    );
  }
  if (variant === 'hero-marquee') {
    return (
      <HeroSceneFrame>
        <div className="absolute inset-x-0 top-[36%] overflow-hidden border-y border-white/25 bg-black/30 py-2.5 backdrop-blur-[1px]">
          <div
            className="flex w-max whitespace-nowrap text-[0.8rem] font-medium tracking-wide text-white"
        ...
        <div className="absolute inset-x-0 bottom-[16%] flex justify-center">
          <span className="rounded-sm bg-white px-4 py-1.5 text-xs font-medium text-gray-900 shadow-md">
            Shop now
          </span>
        </div>
        <style>{`
        ...
        <div className="absolute inset-0 flex flex-col justify-end p-5 pb-6">
          <div className="flex items-end justify-between gap-4">
            <div className="shrink-0 text-left">
              <p className="text-[0.65rem] font-medium uppercase tracking-wide text-white/90">Introducing</p>
              <h3 className="mt-0.5 text-[1.75rem] font-bold leading-none tracking-tight text-white drop-shadow-sm">
                New arrivals
              </h3>
            </div>
            <p className="max-w-[9.5rem] text-left text-[0.62rem] leading-snug text-white/95">
  ...
  if (variant === 'divider') {
    return (
      <div className="mx-auto flex w-full max-w-[420px] items-center justify-center px-6 py-16">
        <div
          className="h-4 w-full max-w-[360px] rounded-sm bg-white shadow-[0_2px_10px_rgba(0,0,0,0.1),0_1px_3px_rgba(0,0,0,0.06)]"
          role="presentation"
        />
      </div>
    );
  ...
  if (variant === 'contact-form') {
    return (
      <div className="mx-auto w-full max-w-[340px] rounded-lg border border-white bg-white px-6 py-6 shadow-[0_2px_14px_rgba(0,0,0,0.1)]">
  ...
  if (variant === 'newsletter') {
    return (
      <div className="mx-auto w-full max-w-[360px] rounded-lg border border-white bg-white px-8 py-8 text-center shadow-[0_2px_14px_rgba(0,0,0,0.1)]">
  ...
  if (variant === 'footer-section') {
    return (
      <div className="relative mx-auto flex w-full max-w-[400px] overflow-hidden rounded-lg border border-white bg-white px-4 py-4 shadow-[0_2px_14px_rgba(0,0,0,0.1)]">
        <div className="flex min-w-0 flex-1 flex-col justify-center pr-3">
          <h3 className="text-[0.75rem] font-bold leading-tight text-gray-900">Join our email list</h3>
          <p className="mt-1 text-[0.48rem] leading-snug text-gray-600">
            Get exclusive deals and early access to new products.
          </p>
        </div>
        <div className="flex w-[52%] shrink-0 items-center gap-1.5">
          <div className="flex h-8 min-w-0 flex-1 items-center rounded-full border border-gray-300 bg-white px-3">
            <span className="truncate text-[0.48rem] text-gray-400">Email address</span>
          </div>
          <span className="shrink-0 rounded-full bg-gray-900 px-3.5 py-2 text-[0.5rem] font-medium text-white">
            Sign up
          </span>
        </div>
      </div>
  ...
  if (variant === 'policies-links') {
    return (
      <div className="relative mx-auto w-full max-w-[400px] overflow-hidden rounded-lg border border-white bg-white shadow-[0_2px_14px_rgba(0,0,0,0.1)]">
        <div className="flex items-center justify-between gap-4 px-5 py-3">
          <span className="shrink-0 text-[0.48rem] text-gray-600">© 2024 My Store</span>
          <div className="flex flex-wrap items-center justify-end gap-x-2.5 text-[0.48rem] text-gray-700">
  ...
  if (variant === 'storytelling-logo') {
    return (
      <div className="relative mx-auto flex w-full max-w-[400px] items-center justify-center overflow-hidden rounded-lg border border-white bg-white py-10 shadow-[0_2px_14px_rgba(0,0,0,0.1)]">
        <p className="text-[1.75rem] font-bold tracking-tight text-gray-900">My Store</p>
      </div>
    );
  }
  ...
  if (variant === 'storytelling-video') {
    return (
      <div className="relative mx-auto w-full max-w-[400px] overflow-hidden rounded-lg border border-white bg-white shadow-[0_2px_14px_rgba(0,0,0,0.1)]">
        <div className="relative flex aspect-[16/10] items-center justify-center bg-[#f0f0f0]">
          <div className="flex items-end justify-center gap-2" aria-hidden>
            <div className="h-14 w-11 rounded-t-lg bg-[#e8c547]" />
            <div className="h-16 w-12 rounded-t-lg bg-[#4a9a9a]" />
            <div className="h-12 w-10 rounded-t-lg bg-[#8b6914]" />
          </div>
          <div className="absolute left-1/2 top-1/2 flex h-10 w-10 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-white/95 shadow-md">
            <span className="ml-0.5 text-sm text-gray-800">▶</span>
          </div>
        </div>
  ...
  if (variant === 'storytelling-editorial-jumbo') {
    return (
      <div className="relative mx-auto flex w-full max-w-[400px] min-h-[130px] overflow-hidden rounded-lg border border-white bg-white shadow-[0_2px_14px_rgba(0,0,0,0.1)]">
        <div className="flex w-[52%] items-center px-5 py-4">
          <p className="text-[1.35rem] font-bold leading-[0.95] tracking-tight text-gray-900">UP THE ANTE</p>
        </div>
  ...
  if (variant === 'product-highlight') {
    return (
      <div className="relative mx-auto flex w-full max-w-[400px] overflow-hidden rounded-lg border border-white bg-white shadow-[0_2px_14px_rgba(0,0,0,0.1)]">
        <div className="flex w-1/2 shrink-0 items-center justify-center bg-[#ececec] py-6">
          <StackedTealShirtsIllustration />
        </div>
        <div className="flex w-1/2 flex-col items-center justify-center bg-[#f7f5f0] px-4 py-5">
          <p className="w-full text-[0.62rem] font-medium text-gray-900">Product title</p>
          <p className="mt-0.5 w-full text-[0.48rem] text-gray-500">Short description</p>
          <div className="relative mt-3 h-16 w-14" aria-hidden>
            <div className="absolute inset-x-0 bottom-0 top-2 rounded-t-lg bg-[#d45454] shadow-sm">
              <div className="absolute inset-x-1 top-0 h-2 rounded-b-sm bg-white/90" />
            </div>
          </div>
        </div>
      </div>
  ...
  if (variant === 'featured-collection-grid') {
    return (
      <div className="relative mx-auto w-full max-w-[400px] overflow-hidden rounded-lg border border-white bg-white p-4 shadow-[0_2px_14px_rgba(0,0,0,0.1)]">
        <h4 className="mb-3 text-left text-[0.75rem] font-bold text-gray-900">Featured products</h4>
        <div className="grid grid-cols-4 grid-rows-2 gap-x-1.5 gap-y-2.5">
          {Array.from({ length: 8 }, (_, i) => {
            const tile = FEATURED_PRODUCT_TILES[i % FEATURED_PRODUCT_TILES.length];
            return (
              <ProductCarouselCard
                key={i}
                className="w-full min-w-0"
