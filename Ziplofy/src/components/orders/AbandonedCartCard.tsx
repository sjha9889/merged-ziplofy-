        ...
        <div className="flex items-start justify-between gap-4">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-3 mb-2">
              <div className="w-10 h-10 rounded-full bg-gray-200 flex items-center justify-center text-gray-700 text-sm font-medium shrink-0">
            ...
            {/* Cart Summary */}
            <div className="ml-[52px] mt-2 flex items-center gap-3 text-xs text-gray-500">
              <span>{cart.totalItems} {cart.totalItems === 1 ? 'item' : 'items'}</span>
              <span className="text-gray-300">•</span>
              <span className="text-gray-900 font-medium">₹{calculateTotal.toFixed(2)}</span>
              <span className="text-gray-300">•</span>
          ...
          <div className="flex items-center gap-2 shrink-0">
            <button
              ...
              className="px-3 py-1.5 text-xs font-medium text-gray-600 border border-gray-200 rounded-lg hover:border-gray-300 hover:text-gray-900 hover:bg-gray-50 transition-colors"
            >
              Send Email
            </button>
          </div>
