...
const PRODUCTS = [
  ...
  },
  {
    ...
    assurances: [
      ...
      { icon: 'fa-shield', title: '1 Year Warranty', subtitle: 'Apple Authorized' },
      { icon: 'fa-check-circle', title: 'Window Replacement', subtitle: '10 Days' }
    ],
    offers: [
      'Bank Offer: 10% off on HDFC Credit Cards',
      'Flat ₹2000 instant discount with UPI',
      'Extra ₹3000 on exchange'
    ],
    delivery: {
      pincode: '560001',
      eta: 'Get it by Thu, 7 Mar',
